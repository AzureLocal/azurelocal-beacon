...
DnsRemediation = All DNS servers set on network adapters should be reachable and return a valid response for the external dns name (see additional details).
...
DiagnosticSystemFailure = Unable to continue, a diagnostic collection found an unrecoverable error. Message: \r\n{0}. \r\nResult Object: {1}
AddingMandatory = Adding mandatory services {0}. Use -exclude to disable checking these services.
ProxySettingsConsistencyPass = All nodes are configured consistently.
ProxySettingsConsistencyFail = Proxy settings (Proxy Server and Bypass List) must be consistent across winhttp and environment variables and nodes. \r\n{0}
EnvVariableProxyByPassListRecommendations = Testing environment variable proxy bypass list contain each of the following recommended entries: {0}
WinInetAndWinHttpProxyByPassListRecommendations = Testing WinInet and WinHttp proxy bypass list contain each of the following recommended entries: {0}
ProxyByPassListRecommendationsMissing = Missing bypass list entries {0} in {1} on {2}.
ProxyByPassListRecommendationsPass = All required bypass list entries are present in {0} on {1}.
ArcGatewayProxySettingsPass = HTTPS proxy for all proxy setting sources on all nodes are correctly set to http://localhost:40343
ArcGatewayProxySettingsFail = HTTPS proxy setting for {0}/{1} is {2} but should be: http://localhost:40343
RuntimeConnectivityTargetFailed = Validating runtime connectivity target failed. Ensure the property {0} is {1}.
'@

# SIG # Begin signature block
# MIInRgYJKoZIhvcNAQcCoIInNzCCJzMCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCo5CbyDPSc0LHI
# UdLJ0RFzHSTe8J0nP15QbcXIvMEIXqCCDLowggX1MIID3aADAgECAhMzAAACHU0Z
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIM7MPiX5
# eoNuCTmzgf0UDl1tYlpp+an5sEf+kpBEM+ztMEIGCisGAQQBgjcCAQwxNDAyoBSA
# EgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20w
# DQYJKoZIhvcNAQEBBQAEggEAl03Flp4tJmrS2Lo5/qTLQPLF2Q0Z4jQNav3zYbgp
# T9VYSEQczMflHzpYr7za1zRBCOTXfqdpeAeL3dAYAdWCkhOaXFbsUS0TVDrbnvdC
# Np6rx9NXckeQJfMb7aUJ1iF6gvddsPS8LSD64KwoMyy79cBtxxhCh77cqrYm9nDQ
# IeEa1NJxu9zPFarzzLpjitsPSfAn2OlN8fYqj5lp7VFbsWL3cj6oExx2s+T4MGIw
# /DE4Te1imOd3xOQaQvWv5DB+qoqKY3VdN4CaWc0gJoBEUyZwYD5o0gB5ZSMp/z01
# GhFxKVMfKsML9amKkvPZpUy52EaT5P7m6EZfw6RfJVCb/qGCF5QwgheQBgorBgEE
# AYI3AwMBMYIXgDCCF3wGCSqGSIb3DQEHAqCCF20wghdpAgEDMQ8wDQYJYIZIAWUD
# BAIBBQAwggFSBgsqhkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoD
# ATAxMA0GCWCGSAFlAwQCAQUABCAGuECBN9827XPrq+1KI39XA1aWh9VBKkm9VBBr
# j/FWYgIGaeeNG/ENGBMyMDI2MDUwMzE0MzExMC4wMThaMASAAgH0oIHRpIHOMIHL
...
# SIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCDCG8RoqUKBOQylsb4XIt7X0qeQJUBU
# t4XDD79RanPdXzCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIEghPTdqm/dR
...
# mmtYNHLZwfdHBrA0Jfu1dxOXSFqdBYowDQYJKoZIhvcNAQELBQAEggIATDRqcLeR
# Z9W4CB3/cNy7syf3pfKG8+ADpvunWQrwyhVWovt4AJh24eW/ycce4OTYufJKcidG
# IYQrmmNRhSzqvh8yNmwFhiathxukQeGFkxfly5fTDzY0G08gVmef+hiEdJI70ctd
# q+aA9V/vpL4c22gp6ZQS5+G5yAFe6X7Uon5kJk4CFIoDF8H7vi8t70InkH082qRX
# wZEFFMl1MNn4xOwKpfNfRopSFitEPy1VdAeQiduh37p2DWMjCxBDn/MYYUFZk5VL
# 5sNAlY33Bxc1jO7x/aq6nmtc+8/74Cms7Xu2vvMJjDAE1bGdXAGS9aYfcQbSLPK0
# r/q0xqCy3uvsBXOtzDZgP+4cuOCkqKQmdnyvrJZp0LQEtlJnNF5uqPZkhBaxDVW8
# KBhQ34cKvUMZ6Ri428Fk9VW5sYAlkrvoxZO3khrZLROoVJfffyDtUgZDAOy5l+kj
# g2LrBUKYT7QIFfc8oChF4C7EHaDPFc07eR581kKF/kbor8b0ypdp+a2MjkmJg0iE
# TBqa/zxt7ZOki4zIBwL3dwKlKCGjmjm4HNQz3PNAbGq4w019KtEcEEOIyU0OsEn4
# tZVjh0cYDMKFCAMdw65B2s17op1MFO4qWZaxn4gtAxXWMkbzgWFa3Vv9pPLVIYPh
# vV3BGHv3QMbTvR8L7zo94NHfpczULlOGiBk=
