<#############################################################
 ...
 #############################################################>
$MetaData = @{
    "OperationType" =  @("Deployment", "PreUpdateJIT")
    "UIName" = 'Azure Stack HCI ARBStack'
    "UIDescription" = 'Check Azure Resource Bridge requirements and status'
}
function Test-AzStackHciARBStack
{
    param (
    ...
    try {
        ...
        if ($OperationType -eq 'Deployment' -or $OperationType -eq 'PreUpdate')
        {
            [array]$ARBStackResult
            ...
            $scenario = Get-DeploymentScenario -Parameters $Parameters

            # Get SP parameters for login
            ...
            Trace-Execution "Starting ARBStack validation, detail output can be found in $($outputPath)\AzStackHciEnvironmentChecker*"
            $ARBStackResult = AzStackHci.EnvironmentChecker\Invoke-AzStackHciARBStackValidation @Params
            ...
            if ([EnvironmentValidator]::ParseResult.OverloadDefinitions -match 'EceInterfaceParameters')
            {
                ...
                return [EnvironmentValidator]::ParseResult($ARBStackResult, 'ARBStack', $FailFast, $Parameters)
            }
            else
            {
                Trace-Execution "ParseResult method does not support EceInterfaceParameters argument"
                return [EnvironmentValidator]::ParseResult($ARBStackResult, 'ARBStack', $FailFast)
            }
        }
    }
    catch
...
Export-ModuleMember -Function Test-AzStackHciARBStack -Variable MetaData

# SIG # Begin signature block
# MIInSQYJKoZIhvcNAQcCoIInOjCCJzYCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDPcxS/vszCq5Ds
# rMxbC/KhHfYHSPBtAivXbfSbaudx3KCCDLowggX1MIID3aADAgECAhMzAAACHU0Z
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIIiFqnOC
# Rm5UC/mkspbU7cwBIQwjUdWq9y2959SCaEdBMEIGCisGAQQBgjcCAQwxNDAyoBSA
# EgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20w
# DQYJKoZIhvcNAQEBBQAEggEAn8Wq/BIImR50+9kvlREhJamcsmZa5M/7NcttovrZ
# atoaJiLf8VZbuxPRoqFc+URPd2Qj0o4Yy5yfAFzPEu67/FdN8h3tNl6cC5iVDRMW
# g38a2zdNITLLDZJcO7PDdJuBfzk+ev06YHQdozbr1roUo/pr7bGvPszf7lpD3jHv
# BWam91ve5mezgwbVzpj/Eak179KMhDmqBvvXSFtto30kfX5tiNQvay3y8DF6tX7m
# NnWil919gcO16HMFRrB6806VyahE1RfzJSiXrpBf/bsIViqtVGhmCR6pjwYBeya/
# F+wFtCNW1JedG7PZNJpzIbIHmGjTSCvZYF4FWMzvqpbpZaGCF5cwgheTBgorBgEE
# AYI3AwMBMYIXgzCCF38GCSqGSIb3DQEHAqCCF3AwghdsAgEDMQ8wDQYJYIZIAWUD
# BAIBBQAwggFSBgsqhkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoD
# ATAxMA0GCWCGSAFlAwQCAQUABCAqXZig0eU1NcaS2CTfOMqlNGaqaFHcsOFNKWKf
# CX98hwIGaedcMrc2GBMyMDI2MDUwMzE0MzExMC4yODdaMASAAgH0oIHRpIHOMIHL
...
# CyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCDZORXMiNcAJxLmmpgyVJIsMqaT
# 3gll8aMTAdHheSkoojCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIHIOI/Q/
...
# x04J9mIfST2NDYTqeHpS2VK/0b1JF/5aWO0wDQYJKoZIhvcNAQELBQAEggIASj+7
# sZSzf83es81BRIFbk1uUQVaMuAkUsL2nYDAu39WviAmxJSM/ZSllA838jUiL8OFb
# 3bq0tYl+69zahBEUXiOZVNyzEXwOvfXg6Jw06B7jcUUWnIUzq7NV/b32ISbf0E0F
# K8PDJx9r+CvMwH/7WvcpkiH/yLALxvFSHV40/eOI/U0wmFjOxM1BA4x52KQqy0eh
# 3GH/U1QfeR8+76Wm+iDVp+4jG11ODo4zQ2dGdXgfLLOgL3shH0N4/07MyBzRiWPG
# m278bD0iHl2yT/vMT+XLi3Jz4XDEQt3M8u9Qydxfr0amrobFXgdynkSFa5gVaBql
# WQb5VYtq6QFHlMA02zI8UT6b9U+4g30rK/UBZRieaNF5GxwfMJHbRbp1UrS3ifXJ
# 7QbO8jLDxk+aihA5S9PtWiTrAY/6WIrBEoIpYPR0aTBbH9XZeeBGHJasT87Z4Qp4
# 3+/BZLmNUzN/NCsB+9SNsK/T7mwUM5RdMUa/LeT/Sw2DMRQfz6go9zNtaJyjs9PM
# Yr3dMaOT3dzTD0nW26Z2l1WabEouMs9W+7Uxbg5/iSCj9AadtLBR7zOoLVSb6FXs
# XySvzNijIWy78XL60r2VGCrJnHshx15+x1qbrTBo5mHC4OZw5UWdzn+2DNEjuDnN
# H8QX5/YFBdyDYDYMJ8xGhhGXNAcI5z/EdtRYSBg=
