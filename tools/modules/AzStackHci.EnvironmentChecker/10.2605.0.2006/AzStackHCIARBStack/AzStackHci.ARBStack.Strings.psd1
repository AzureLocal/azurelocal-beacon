...
###PSLOC
BandwidthInfo = Starting bandwidth check validation.
BandwidthSuccess = Successfully downloaded ARB canary image in '{0}' after {1} seconds. Expectation is to be able to download within {2} seconds.
BandwidthFail = Failed to download ARB canary image in '{0}' after {1} seconds. Expectation is to be able to download within {2} seconds. Please confirm that the network bandwidth is sufficient and performing optimally
AzCLIExtensionsInfo = Starting Azure CLI extensions validation for {0}.
AzCLIExtensionsCurrent = Currently installed Azure CLI extensions: {0}.
AzCLIExtensionsSupported = Supported Azure CLI extensions: {0}.
AzCLIExtensionsSuccess = All installed Azure CLI extensions are supported. List of extensions currently installed: {0}.
AzCLIExtensionsFail = Unsupported Azure CLI extensions detected: {0}. Please remove these extensions to ensure compatibility. Supported extensions are: {1}. List of extensions currently installed: {2}. Run 'az extension remove --name <extension-name>' to remove an extension.
ImportInfo = Importing {0} module.
LoginInfo = Logging into Azure using MSI.
LoginSuccess = Successfully logged into Azure using MSI.
LoginFail = Failed to login to Azure using MSI. Error: {0}
ARBLockStatusInfo = Validating ARB is not Locked.
ARBLockStatusSuccess = ARB is not locked as expected.
ARBLockStatusFail = ARB is locked, {0} locks found. Please remove all the locks for the ARB ({1}) to proceed with the operation.
'@

# SIG # Begin signature block
# MIInRgYJKoZIhvcNAQcCoIInNzCCJzMCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA+UhNMJ08VQ03j
# c4kzXiA7bZxZ9F11ZQG59Pfj6LmQ8aCCDLowggX1MIID3aADAgECAhMzAAACHU0Z
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIM6Cnk5n
# HeQOkMxiXPj1MN4VR9H3//2PWLOEY7H0MigRMEIGCisGAQQBgjcCAQwxNDAyoBSA
# EgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20w
# DQYJKoZIhvcNAQEBBQAEggEASW4nJGzUqMtoa0czk4qTBQ2zHtKmGlp4fRrof3Aa
# +oFhCMOh0F9rrUSNsUjU3ItccwHtMOzm53Xfln6cdBK19uKT98OcG9S+Nxms3ib6
# Ni1urzZZBXht8HHJOSkxqyaGfXcPDXVPkGwmeDUbddFW39nip0y7H/+j+1LEXOOC
# 9EEpTxdszNRzN2YpErEjCPTcNnxL12Sk+hVwGd3F3n+V68ySTruy6jTChYuqVzzR
# yUplqoeX2G1XB6lQmKgamIKL8M+lB7deJyBhITXN6oywcsMRqIDQOh/AdidNXqs1
# /O0KZSMPP5B+MC/Oj/qL2MHhUmq0GIcZViLY3L384h6cKaGCF5QwgheQBgorBgEE
# AYI3AwMBMYIXgDCCF3wGCSqGSIb3DQEHAqCCF20wghdpAgEDMQ8wDQYJYIZIAWUD
# BAIBBQAwggFSBgsqhkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoD
# ATAxMA0GCWCGSAFlAwQCAQUABCCxfU3eO6u9qM2Wu9I6oe+kYuSl4dsMarRhmXGP
# 21ASVwIGaedeW7IVGBMyMDI2MDUwMzE0MzExMC4wMDJaMASAAgH0oIHRpIHOMIHL
...
# SIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCAhCXWdpbI+cOPLlG71sU1wH2iuaieR
# 3kEB8KwUKEs4XjCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIFWxikZRYGNf
...
# DcPwUXJi0s7Mn7qi2o2Z1BZ5LZlH28swDQYJKoZIhvcNAQELBQAEggIABS2EaTSg
# I2clTV0zO8x+e86uPX2Grr8kOK7LLkuTreT3RmgUf9ZvcyG6/LFVFI6DTn2cQGeT
# u+k74Nhf0nl67uwz1yAUWbboCk0jB88gusRCWFQBXRWnTd13lFhBWn9lwQt53bXE
# 5txzYufO+Djb/4J6eeaBPRBP1UL1nSXPy3jQDH9QarYOMGX14FXC1kGE5OktizfT
# YGgovo/ZAUtwSKE0L0+yaVjh1YIj3JLiHhkydPGjJ5wzucKieIhvbLHIWDJSCtOH
# 6daRxYPxN6ZEz6vD3vKK/JjEBW6V66mFL8UVTdDYHics3Uf9BnW5u7Snf+gbsw1S
# 5FuwETok8/4RQ51F0qv6iVG8n3ct6dJ6fUHU0nKMLmrDxEjSj/bHkz+HrHDIrxsK
# XqiVvLv47oM+8deN7WnfrVl1APVWorShg1zJ5oZX+98iOp74DEb/0wtc/Zv/GHs+
# wKYiT2wCkbX8D6rQudlGg4dB3cW8eLTTBQzLxetLMrtyuxO6CgsVOiBpoFzFE7Wk
# hzGKtrpLZZUW0HIEDMiOSTQP6yLocjzJBvKnpqD/pbscjt7lrKumcQVyUu9dzp+Z
# i7KMwrZ+d77skU0xovcy/+E659cQ306rb4S7hyv+PJ1Udx9Olxfejk7IHBNkAqnx
# ++LLcYyfbtgm7/mw97QRHv41B/Mkq+0pXW0=
