...
$MetaData = @{
    ...
    "UIName" = 'Azure Local Network Storage Connection'
    "UIDescription" = 'Check storage network connection requirements for Azure Local'
}

function Test-AzureLocalNetworkStorageConnection
{
    param (
    ...
    Trace-Execution -Message "[NetworkStorageConnectionValidator] MetaData: $($MetaData | ConvertTo-Json | Out-String)"
    ...
    try {
        ...
        Trace-Execution "Starting network storage connection validation for $($OperationType), detail output can be found in $($env:LocalRootFolderPath)\MASLogs\AzStackHciEnvironmentChecker*"
        ...
        switch ($OperationType) {
            { $_ -in @("Deployment") } {
                ...
                [System.Management.Automation.Runspaces.PSSession[]] $psSession = [EnvironmentValidator]::NewPsSessionAllHosts($Parameters)

                if ($psSession.Count -le 1) {
                    Trace-Execution "Only one or zero PSSession provided. Skip storage connection validation."
                    return
                }
                ...
                [array] $Result = AzStackHci.EnvironmentChecker\Invoke-AzStackHciNetworkStorageConnectionValidation @param
                ...
                if ([EnvironmentValidator]::ParseResult.OverloadDefinitions -match 'EceInterfaceParameters') {
                    ...
                    return [EnvironmentValidator]::ParseResult($Result, 'NetworkStorageConnection', $FailFast, $Parameters)
                } else {
                    Trace-Execution "ParseResult method does not support EceInterfaceParameters argument"
                    return [EnvironmentValidator]::ParseResult($Result, 'NetworkStorageConnection', $FailFast)
                }
            }
            default {
...
Export-ModuleMember -Function Test-AzureLocalNetworkStorageConnection
Export-ModuleMember -Variable MetaData

# SIG # Begin signature block
# MIInSQYJKoZIhvcNAQcCoIInOjCCJzYCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAYMNcKXMgxQ+Pw
# y4wdGsmmEKesEL57i4O5vOVeCuZK/KCCDLowggX1MIID3aADAgECAhMzAAACHU0Z
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIIb7E2CK
# XkyLbbr7WhrouIusKbnBULimPjDivmENQjSAMEIGCisGAQQBgjcCAQwxNDAyoBSA
# EgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20w
# DQYJKoZIhvcNAQEBBQAEggEAZ/Hi94gQdFyDsXzxmYWuUT5A6wbHatSsWcbBI4Kq
# JeJcKmtAhHQKHEAPp42BqqAUcKn1zrojBBGDqrfNIhifJMlltEe2yvd1JPaq4DnO
# sAxhNbVbtkPRjzP+gjWradqN81878e34Md+Cqu0Gv6xZ7mO7oktwfxXWH8PvrGTn
# bd1MpemVD1uzL5CvsxfX4tIBBEJHjZ5+Yj64L0MPjpiHISbrN1MrmJHtrEwgbROV
# q4+tp1TEAid4AEQPBQCa7FNoXk2/+SK39JAuQL2sAMTECUg98ftzpNI9LmeTcP4W
# z+ZKro5zoGyPTz2BQHxRB2bIv9Tutsg5vIqIrX7OErj+BKGCF5cwgheTBgorBgEE
# AYI3AwMBMYIXgzCCF38GCSqGSIb3DQEHAqCCF3AwghdsAgEDMQ8wDQYJYIZIAWUD
# BAIBBQAwggFSBgsqhkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoD
# ATAxMA0GCWCGSAFlAwQCAQUABCDBAIN6Svn4bYFBs9U50SPiJdb1Ypn1NUiRu3Sz
# yECusQIGaegM03WBGBMyMDI2MDUwMzE0MzExMC42MjZaMASAAgH0oIHRpIHOMIHL
...
# CyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCCZz3S5e5+8fVUiL3czSVKOtqHK
# PVlJtrH4kTcxJBvPPTCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIADvIQef
...
# /2NfQQlEyV4KLOoV/KIa0Z1/P1GDErJ2ajIwDQYJKoZIhvcNAQELBQAEggIAUaM6
# OamX/dJV/cXZDYS2BkReE7dcoNClHwAdK3sUcI4id1U4G50cOhQR5nNQEzjk6qo6
# 30thTQrTueYMQ8hQAitg9HhPJU2EpEGigV9f24RPq8YOSS7RJ6wCmcrGZ0XdyIVf
# QfAP8bv9UDKQ5n1/xMPHMhsOa76BTZUL+wsdgvjC9SajWvp75J9kJTpW6xaMMqBG
# lYNk6qu2Ca1jWhVX2ECjiqigyMHLnN6vUw4JMZb4LUx+5kLGN378qHTDVE2gOs59
# vjuRCMMxB0+scPI58Ro7Wz4EDQtNJIgaQPapqflOGHEMuNPU2QRhts44avGS7xoC
# tP404rgYCKtcCE8EivUV2igGIAHyGSxCN89e+4cSZ/xak0k1L+q7scXX7hRr6Foz
# oSWwBQReW/05tR9woHOuLPoIyBYCN3aKNBuT2yMmxSG6MIKWq040sBAXfJbUB1Dq
# zL2D4cS1hr1X+/NDSKPY+MHU+2m/TcntlTmu+wLBK8jCvSOb6+GBxLu079wm+UcK
# 47H0Sluh0zBqmkQvNdHud0FEGW8zMPPukGAhXDN6hKfNQo/Gz4OzZn1h6ReZnGk2
# 4Atv8OaLr030KY1RHRfufzNzQFokkyDVQ0Clvb19uxpU0GYRQbFEZOx27HCL/EHG
# WXxT/UEJp7fHfE8R4DumznKY5oe05ewOT5q3VU4=
