...
###PSLOC
StartICMPTesting = IP addresses retrieved for all hosts. Starting ICMP Full Mesh Test
ICMPTestSuccess = ## Ping successful: '{0}' -> '{1}' with AvgPingRTT='{2}' ms
ICMPTestFail = ## Ping failed: '{0}' -> '{1}', as No 'Average' found in ping output
FailSaveICMPJSON = No report data to save, fail to export JSON file
StartTCPTesting = Start TCP Full Mesh Test
StartHostTCPServer = # Starting TCP server on '{0}' with IP '{1}'...
AddHostTCPFW = # Adding firewall rule to allow TCP port '{0}' on '{1}'
TCPLatencyRemidation = Please double check TCP_Full_Mesh_Report.json and FullMeshTCPTest.log for more details. Then review end to end network configuration and retest.
StopHostTCPServer = - Stopping TCP server on $serverHost...
RemoveHostTCPFW = # Removing firewall rule on TCP port '{0}' on '{1}'
NetworkException = Test data not found. Please check if the server is reachable or if the firewall is blocking the connection
'@

# SIG # Begin signature block
# MIInbgYJKoZIhvcNAQcCoIInXzCCJ1sCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBXbfZG0amT+zRN
# PF1md/WI7NJrNjQjjSYGFNYcgqAM56CCDMkwggYEMIID7KADAgECAhMzAAACHPrN
...
# hvcNAQkEMSIEIFeW814Tbiy1ykGZQ3VTZyoHKpxfTyw8dSj3HTkym1dVMEIGCisG
# AQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3
# Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEBBQAEggEAvZUpdWRuhjG6HLdtxJnj
# /kjBJdG2XWf13H7+XbXyi36MKSmwq6+9Va/GJ5E8GDpmZdm4Y+SW/qG4+ML61PXZ
# aIS5fB2nIRIIYezPzJOzcfMsUiM8Fq1e7odmf0x0orEfg1WEsAK8/V3+RpF7lUyi
# 1Zd9yZehrSj3bVCzbFVYgRRKi+n5VRDlSEZcXv1GkpY1VnPlLZ6rD0NC/sSGRcwb
# dqxLBdFtj3HSLdIYa0lcE3pbomEjWRHahxOO6OHag2w3mmWzS+jEmxOaOjS+JVHP
# qvvFQr35NHPqJtDDgAH7UfxVgPf0rrVyjEz2WiXNdM7patoHdSvw2kRSTAbLc9Cg
# +qGCF60wghepBgorBgEEAYI3AwMBMYIXmTCCF5UGCSqGSIb3DQEHAqCCF4YwgheC
# AgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFaBgsqhkiG9w0BCRABBKCCAUkEggFFMIIB
# QQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCBJ/+xl8zLbVuxQbLkT
# tRlMFKBL1pRNtwv0iXIZOgazHgIGaet1mUlBGBMyMDI2MDUwMzE0MzExMS42Nzha
...
# BDAvBgkqhkiG9w0BCQQxIgQgOhqj8/xWHU60mE7NcCpUbNmK9WhzdYmXIVx1dkwg
# aKgwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCCdeiHHrbtpKcwB20doVU89
...
# yavIHZTcYA5xN6GxveJWMA0GCSqGSIb3DQEBCwUABIICAJM/NoJ8Jx1rBmNKsOMJ
# 5f51hkRKi+YFQyksPh6AkNjHtsgC97DNwBIOMBAm0p4INPM+xSKrKx53isDju7XH
# OhV0Q68IOzCPqB0EpbQ98c/h/LAQJ1nI/NCgkRe6xvNa0vHFFbqxvcQUI6AOXbD4
# fXlwoH00zLe7SghOXx+hTdKz50cJDmhedlWUg0HihAJ0238D4UlB6OSNTD9AWaDH
# NfUtjvCtKRxIEGlKK5BxZfdD5wMp3S59MDgwKcR7tS1HB4vZpHh6RHXPJhLSzKrJ
# 21baHVCxo3a42R/rycF+tYWPCDWDFeTT3w9NvJIGrUunwNtM1DzclIaOcDI4kS3P
# Hejsp0XzP07SNbZm+GWKqb5IbneY0/wjF7GEl0evWoQBuB3nVQFsIBHTAkbOIevp
# HHJMu38xDNqHpiEo8VwB3OXh0FZayeCOFSbsNdRNUyp5ODJfUTlBBjyqgju7kjWC
# Urz26+qaXHy/Pclkq6nODznc/l0y1pFfbRR1tcRQyw+niXribp64t5fOxENS2PkZ
# IvEwkzmy2yTl1cuJ1to6A40F5X2yAb05CMYvi2IsahsMUTW4W8rEKA32lO8IaRXQ
# DLg7etstkXGMoXCWv0HkmqNDuPw+sj5qARhYzEuYzCdpLSwdT94pQuaZmZB4As4N
# 94yoYMEjILNNBDeViKdS6IJ7
