...
TestClusterNodeName = Checking if ComputerName(s) '{0}' are in use in the local cluster. Result: '{1}'. Expected: '{2}'
RemoveClusterNodeName = ComputerName(s) '{0}' cannot be added to local cluster because they are already in use.
TestComputerName = Testing Computer '{0}' is configured with IP '{1}', result '{2}'. Expected '{3}'
NodeNameCheckError = Error testing if computername {0} is in use in local cluster. Error: {1}
QuorumCheck = Testing cluster '{0}' ('{1}' node(s)) quorum resource '{2}'. Expected '{3}'
DriveLetterConsistencyCheckError = Error checking drive letter consistency on node '{0}'. Unable to find drive letters using '{1}'.
DriveLetterConsistent = All drive letters on node '{0}' are consistent '{1}' with the cluster.\r\nCompared with existing node '{2}' which has '{3}' drive letters.
DriveLetterInconsistent = Inconsistent drive letters found on node '{0}' drive letters '{1}'.\r\nCompared with existing node '{2}' which has '{3}' drive letters.\r\nPlease ensure all drive letters are consistent with the cluster by using Get-Volume for drive letters '{4}'.
'@

# SIG # Begin signature block
# MIInSQYJKoZIhvcNAQcCoIInOjCCJzYCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAOmzmiNlA9/np1
# gcTiiyMsBzLmFfcWzFyE0yFpNkm96aCCDLowggX1MIID3aADAgECAhMzAAACHU0Z
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEN9NS6g
# fCm+A43opbYZDT5835b11nqul9lSNrgTO7QrMEIGCisGAQQBgjcCAQwxNDAyoBSA
# EgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20w
# DQYJKoZIhvcNAQEBBQAEggEATVbSufH/xrheDd93tkQYyrrN35sishqsLoSnrjIJ
# t6VIZtFgsTH660hx/VTIISegW/n1HlQYsq1S4UF7aQ61fIyZSNTSLzewM3vT4vr2
# AXVa/HoUWU/tj7aMqG/DUAwyB3/PpnGfOExVZY/ma6rSnhWsOCTotur2noVjxGBC
# mFWeXMsugbfgfdGId+HLP2poBX4X5whdUKXJSplqu2+apsMLecDW0sH4tRyWauWJ
# 8jglfhV4k4laNth7FBq7C5z9RgF1jmqeJFiAVXF4o7gqpLY7E/Rho5cFIOPsu8Fg
# cDt/fBidEEiAWEsOhtWrx+7vqnMECp9yTefx/+I+MF6V3aGCF5cwgheTBgorBgEE
# AYI3AwMBMYIXgzCCF38GCSqGSIb3DQEHAqCCF3AwghdsAgEDMQ8wDQYJYIZIAWUD
# BAIBBQAwggFSBgsqhkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoD
# ATAxMA0GCWCGSAFlAwQCAQUABCDneg7K/fW2tItZcchV2EF1rpAAgB+zx+nfT0ur
# fD6t8gIGaegM03V3GBMyMDI2MDUwMzE0MzEwOS42MzZaMASAAgH0oIHRpIHOMIHL
...
# CyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCA+GOhWBzJXvz7AT+HaVHt1EZRB
# X7gF+jCcHDu+H8cJ0TCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIADvIQef
...
# /2NfQQlEyV4KLOoV/KIa0Z1/P1GDErJ2ajIwDQYJKoZIhvcNAQELBQAEggIAFWuR
# 5GX+pftk7NLj6KmwSlu/Z/BkHlq9rpwz22fdEDzViBKERNJ1WRQzvP/w081KL5PL
# wk1BMSYwHeH2EMjvHfr2q5/9I2U+1Xc2aJrLRqLoT1LoXnOEkOC0PKd5xv2ihf9n
# 3D8gQcIm0eoQHeZlo0XRqIolieuLdr63wuJl+u3hnnEdwPvAWVuKMNd2mskdQGUR
# Fffhju+WKjEx5BJYmNRBsfSkGtaACv+6+039fkS5UrpBkYc3oUNQEJHoDWx0Z+b0
# 8Ew7VhUSFHCfVl92cDN9sKcze5cjVtYMdHIvQpQ7qfJPK7z27G8C6b5uptVBVoAD
# OJ6ihsamZQ2RRLvPAIkUpDsKQH0aqScmFlg03F6hyNIf3zFtUvx78eRVnwBn5FYC
# jGycdoEjyeQfLHpXk/FxAX4JNBw8duHcu+0x33fxLNvdbf3LRtuemDwWx/nP0s4S
# cUwHpkLz4ZImBmytcSOYDBAUNdbn5c/tRRpegIbolKNOiNLED9ZkIVuSme0eX8yX
# LCvLLeRDkzK3/ZEziEVjlP0RyWUXq7spW7Y8+IZ8rg8pPOHFma7dnWIz7pSRnL1h
# ril3eLkO/I5doUjNzK2uMbrEWiI7bvFdwPhXFU9CwBDovNyvhlHGEAPQ/6A4P4Xd
# YepqCp/qXLhBSgubgLt4vtMMmrql5Mw2PrRTXDw=
