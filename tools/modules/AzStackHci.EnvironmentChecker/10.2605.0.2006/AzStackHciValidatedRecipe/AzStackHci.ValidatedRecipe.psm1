...
Import-Module $PSScriptRoot\AzStackHci.ValidatedRecipe.Helpers.psm1 -DisableNameChecking -Global

function Invoke-AzStackHciValidatedRecipeValidation
{
    <#
    .SYNOPSIS
        Perform AzStackHci ValidatedRecipe Validation
    .DESCRIPTION
        Perform AzStackHci ValidatedRecipe Validation
    .EXAMPLE
        PS C:\> Invoke-AzStackHciValidatedRecipeValidation
        Perform all ValidatedRecipe validations against localhost.
    .EXAMPLE
        ...
        PS C:\> Invoke-AzStackHciValidatedRecipeValidation -PsSession $RemoteSystemSession
        Perform all ValidatedRecipe validations pre-existing remote PS sessions.
    .PARAMETER PsSession
    ...
    param (
        ...
        [ArgumentCompleter({ Get-TestListByFunction -ModuleName AzStackHci.ValidatedRecipe.Helpers })]
        [ValidateScript({ $_ -in (Get-TestListByFunction -ModuleName AzStackHci.ValidatedRecipe.Helpers) })]
        [string[]]
        $Include,
    ...
    try
    {
        ...
        $testList = Get-TestListByFunction -ModuleName AzStackHci.ValidatedRecipe.Helpers
        ...
        $i = 0
        $Result = @()
        $ProgressActivity = "Checking AzStackHci ValidatedRecipe Compatibility"
        if ($PsSession)
        {
        ...
        if (-not $PassThru)
        {
            Write-Host 'Validated Recipe Validation Results'
            Write-AzStackHciResult -Title 'ValidatedRecipe' -Result $Result
    ...
    finally
    {
        ...
        $envcheckerReport | Add-Member -MemberType NoteProperty -Name 'ValidatedRecipe' -Value $Result -Force
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAt/s8WV38axNH2
# c7mj2SIhc+YlNoPOohasQPXylcUUUKCCDLowggX1MIID3aADAgECAhMzAAACHU0Z
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEII8scswL
# CeqYiAW1OxVKF4vb0P+GpfRoieHQ39MedYM/MEIGCisGAQQBgjcCAQwxNDAyoBSA
# EgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20w
# DQYJKoZIhvcNAQEBBQAEggEADW3UyMEZXioREr3fSPYyOGN1Ia+jDafQcS3mjhp6
# l6bE2JILGl78I8xJ1U8xRFT6cegiuXuhhq9aw2SSZZY1eG4FgPZHc41XFBasaOAt
# uKpzrErqEGZ+dcDyJNKUB0MLE/qqeX8HSFjaajMAfJlRgV5i0hitttnQfkU/JsGs
# wZedR3yryOgXw7g89fwGyfHn4TtVn1uup+o3P5sExGv27VfPJ2h/PWkLlgsLNdmp
# qLrUp8uV+6ouSUniiffp/UqhZ59+lqheXKOlgC24qlig4OmH0f8o/rwTgVNhhxXp
# ID6ZqHtVh4NqOmUYbtspaAmjNrMtHLCqjYLbOmhN9aWYG6GCF5QwgheQBgorBgEE
# AYI3AwMBMYIXgDCCF3wGCSqGSIb3DQEHAqCCF20wghdpAgEDMQ8wDQYJYIZIAWUD
# BAIBBQAwggFSBgsqhkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoD
# ATAxMA0GCWCGSAFlAwQCAQUABCCBRMKfGhGqRAeTq9ZLJfDdmE0gqwGJGPygL6eI
# aykuKwIGaedeW7IQGBMyMDI2MDUwMzE0MzEwOS4zNzRaMASAAgH0oIHRpIHOMIHL
...
# SIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCCcRbGp5MQ1rCcUm3mYNt+jp0fi01xO
# Q6ySXazLxa6FkDCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIFWxikZRYGNf
...
# DcPwUXJi0s7Mn7qi2o2Z1BZ5LZlH28swDQYJKoZIhvcNAQELBQAEggIACZKtTGK5
# 6abi/z1ZRusksqGge2zQ6x3KVlyP87j8d+X8V4HWrHHwC1lIVt7dNlmvju5K6smo
# g0Hyh6WgDbZWc6GwCYPIv/0JC7SVITdeSjg+gf4JWuY/JuNhWdk5xuLXGlgBte9z
# ditncNokPoYRmSVQeF5LaT/jYikHgxBU/sHUpG7iCVmriu9P2PP3hQkMaUxaZs6F
# h+lAfUrD8sFax4NibDnCMsT3PmKvh1H+mhYJfu4fgmzrg77uM5npcO4dSW6MAc+Z
# vSohXoEk4hTt5v4jU+djhKOoV/QWZuCIS7bggXcXh/Yckzx473Nnz2PrPAdjS40g
# t2FXYEmm7Mrh6VCz7rEoNQK0Mfz5tD0PZeQUW2pV58N8aiR8mclr2B2zqhuUQ0PP
# VLZl6p96WT1qRPTcC6fZxXFPKgKl+jqJllTXewll0FJ4CwxGuuOlhOCjSYns0qSq
# e639+I7LeK07nQ9DNP6QQuAvibMozVmAyF7xWE2QoZhxHIB9Sy4rOLqIXpenLu7l
# MgwoUUE1fZVt0Gsxr7vDNHr4QXE71yXm/pexJ9THQiraZhuhcTPzIn544a2Li5Zx
# jrUvks15AjgJ1NqWc+kcq/bL7Wlcw8FV5yvt5i0ycrYtr1JmR75d+2G3KXgL4JWN
# ZYfnLFFRuxW8PeggPx6ECMzgmwlw4PJozRA=
