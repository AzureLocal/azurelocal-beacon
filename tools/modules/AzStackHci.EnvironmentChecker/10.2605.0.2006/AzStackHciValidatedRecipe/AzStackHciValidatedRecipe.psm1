<#############################################################
 ...
 #                                                           #
 #############################################################>
$MetaData = @{"OperationType" =  @("PreUpdate","PreUpdateJIT")
              "UIName" = 'Azure Stack HCI ValidatedRecipe'
              "UIDescription" = 'Check Operating System requirements'}
function Test-AzStackHciValidatedRecipe {
    param (
    ...
    try {
        ...
        if ($OperationType -eq 'PreUpdate')
        {
            ...
            Trace-Execution "Starting ValidatedRecipe validation for PreUpdate, detailed output can be found in $($outputPath)\AzStackHciEnvironmentChecker*"
            $ValidatedRecipeResult = AzStackHci.EnvironmentChecker\Invoke-AzStackHciValidatedRecipeValidation @Params
        }
        else
        {
        ...
        if ([EnvironmentValidator]::ParseResult.OverloadDefinitions -match 'EceInterfaceParameters')
        {
            ...
            return [EnvironmentValidator]::ParseResult($ValidatedRecipeResult, 'ValidatedRecipe', $FailFast, $Parameters)
        }
        else
        {
            Trace-Execution "ParseResult method does not support EceInterfaceParameters argument"
            return [EnvironmentValidator]::ParseResult($ValidatedRecipeResult, 'ValidatedRecipe', $FailFast)
        }
    }
    catch
    {
...
Export-ModuleMember -Function Test-AzStackHciValidatedRecipe -Variable MetaData
# SIG # Begin signature block
# MIInSQYJKoZIhvcNAQcCoIInOjCCJzYCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDYnHiYzNWxKQ86
# llRTONFfFld+Z4qTYiTaIFW1wAKftaCCDLowggX1MIID3aADAgECAhMzAAACHU0Z
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIDw1kcpD
# tAMgbkSybTg5P/Vn2hgGXV0uT+N+sDjtRRiBMEIGCisGAQQBgjcCAQwxNDAyoBSA
# EgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20w
# DQYJKoZIhvcNAQEBBQAEggEAQAghpUq4Q6xLyps5sz9Emm9R7/24iJ+zXm1RezqG
# Z0JgFaejNcME5abG8aeNCdMmyd+VhJt60majb/3hNp6siv1fGhRAKoSTJ+Kr2zLw
# KWTlfVCa/ZkWnXsgja8WO0pAvKXN/KSys9e8h9EyKxGSGAKx3M5hw/K7hVwsxp7V
# iW/QViCessf6xdy2P9ORgeKd6/IN7WBq9IK3sxBc8gnloHusaw6CE9Dgo4D63Y0o
# ELcCmyPOK+URWCaAB0Q2blMaULKpCHN+0U46S7emJ8iZypFDDkbpB8futRvJi/EN
# EOyk7su5y76T9gbQiavrZebrHuXPZtIs22P/A0GurMR5IKGCF5cwgheTBgorBgEE
# AYI3AwMBMYIXgzCCF38GCSqGSIb3DQEHAqCCF3AwghdsAgEDMQ8wDQYJYIZIAWUD
# BAIBBQAwggFSBgsqhkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoD
# ATAxMA0GCWCGSAFlAwQCAQUABCCsaZaXq3ZNGDJvFtVzzddZQh/jbnLkcXYsTa/Q
# LzJx0wIGaedcMrc6GBMyMDI2MDUwMzE0MzExMC43MjZaMASAAgH0oIHRpIHOMIHL
...
# CyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCBD513lYWFq7rea+J5zcSwkBMY3
# yr/pUZ8NIMKd+RdKNjCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIHIOI/Q/
...
# x04J9mIfST2NDYTqeHpS2VK/0b1JF/5aWO0wDQYJKoZIhvcNAQELBQAEggIAcoV4
# ighwR15SzmqD3SN5Zmxf4BlRNjjMTUM4PQX1Ms84+pztgABrnq9fVjhxgMAO4W1n
# poWT6Gi2g8cmd3J2gyh9R6vR7BX4anEWGiuxtSG2msJkgR3GAvD+iC6cJwOpi4za
# 9Qo5Vat97YfQVQjPF+zKMqZnVxb3NqdgAkXqtYIHMCljN6rTpUSXFCiKGPNkWg5m
# 8VTbAuyCOUciM68emftCHpRJucvA7nkiTLTiKA0JcAN4h4bsPvsmldkFmxQmbPo/
# MmGZbM8z3S5AlnxNzfxVc0IMK40zgGZl0Vi7qvHA6aQUk791uolB+8S/ay720x+9
# hQQVo+RRSQqhwwz3Jj11MFtE49d7YKKVTCsXOuyE5Gn9NEplBljlnFEmtzUK+mM3
# 0OgsCrhopPar6yvVD/WeiWQqCrv81EtKlIIy0idMxGa+gDJaBdIhvim6frJnbvSA
# G/GmvIkW9zYy6pJctnolgMPefoui6dymfPLodyu4qbve4CtpLOo0D03I2N+EAL/V
# zjTMzJ+J5Jjp09EMuO7x+fwm5PdWWwuf/Qt94d7V7RVd/wq1iLCUgzg4obqZExAn
# fJJvo/VcxPVHrfsTdtDFNUnfiMbOPuaI5joYAHK+8GsbwPU+wFpPGTqipafo5YsY
# iOp28vfp7obthgLNdpebDA3/t2ol2lLNw3YHeZM=
