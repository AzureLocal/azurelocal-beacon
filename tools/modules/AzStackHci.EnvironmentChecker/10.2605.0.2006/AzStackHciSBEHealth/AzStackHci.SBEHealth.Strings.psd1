...
###PSLOC
CopySBEToNode = Copy SBE content from '{0}' to '{1}' at path '{2}'
RobocopyFailed = There were errors copying files. Robocopy exit code '{0}'
SBEPackagePath = SBE package content path is '{0}'
NoHealthChecks = SolutionExtension module does not implement any SBE Health checks.
ModuleToImport = SolutionExtension module to import: '{0}'
WillCopyToPSDrive = Will be copying {0} to '{1}' via PsDrive mapped to {2}.
SkipNoNugetPath = Unable to get nuget path via Get-ASArtifactPathLite. Nuget copy will be skipped.
'@

# SIG # Begin signature block
# MIInSQYJKoZIhvcNAQcCoIInOjCCJzYCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBt/4VTl158Zdr+
# 8mQ5IiB6AzbmASIdTYTty1kA3CX1xKCCDLowggX1MIID3aADAgECAhMzAAACHU0Z
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEwNW+Pr
# 9BYEI51It2hP4LZpvc/URBGJUnG9bbnOhOZaMEIGCisGAQQBgjcCAQwxNDAyoBSA
# EgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20w
# DQYJKoZIhvcNAQEBBQAEggEArwYEudbTeTtm8R6D4N+eJ4+JJ0NGZP9KOSZFFqKr
# dEc+0hjY+sVgARa5y/tfQYAM0sZNqqTLPTEZQyhiVQ2BnKQgIib/iYBpMhmWhxGT
# oVJdWuIsrSxpSyQhZJSOzCi++qfrnq9UKTVtUYLy2nmRET7Pvh7vy7OTo2ZVP+oH
# 3dGXXaQg0ZN2+UstJItcPgIaT5NgnrPp+RICzkK7jItX2tibCeiDrjybp64aNj+g
# lOnfz1qJeTCQf50gFjyiExJUb0F+G9KuRi/V7FZ3nbuyBlzMeaqXCExLNEbmSxy/
# upTJYEeRIDGAmlRTKm37BjiHBt/8dqOoE91GTEnSAtxru6GCF5cwgheTBgorBgEE
# AYI3AwMBMYIXgzCCF38GCSqGSIb3DQEHAqCCF3AwghdsAgEDMQ8wDQYJYIZIAWUD
# BAIBBQAwggFSBgsqhkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoD
# ATAxMA0GCWCGSAFlAwQCAQUABCDjXRYNVbe7s0bioT/DFjBuGLCwm3aYwgnKbwps
# 60tM+AIGaefsSb9WGBMyMDI2MDUwMzE0MzExMS41MDNaMASAAgH0oIHRpIHOMIHL
...
# CyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCBhs9RYzIyIc83wG75bM1TC0sND
# Z/dm0F6LpEMqNzJQ7jCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EION7vyOl
...
# CfUpoXjUtBZKerlMmArdnX03kdlRHISH7mUwDQYJKoZIhvcNAQELBQAEggIAXASn
# d7S2UHCRQ5eaFyV/CePXeQJeQZPzsK+nr6qAc6X7aOt3toPXvHtCyRX3tWFcaROj
# svvNHKuaI0EBhVwK7/9ujCQFDV+/8Ry6Qv6gU/QYKN6w7DMbxaFCmJWlGdZw9Zq1
# DmSAelyVrzKxGLNDfvkIciU3aoyKgwdcIgrJ1CvKmLhjqxybg9ZeEOJXwKHkuSDM
# zRmoHWPPi5puuAazP+re9C0Brlj4mfKzF+KzP6gDBzm8cLYUTjNCzBTQIW1JqQNp
# w+veOOPM9f4XIXWsLBTDAAh8+VZjh5Tiu2pjCnalgbW/ktUWWyFXb1VcD/rUKe0A
# +lSONMqRWFNr+iVmZexqE5g+7Y1GdEt/hpGJWiYAkiwVsDkz2An2PasRo2l4l8W1
# j4BDMfZ/3bRCVQilhTwnJ+8785X9QmDY+XC+AjHchwcQVj10iBqlaUF4LFTbFZ9B
# Sz1Gm0wQoGaodsMVbD4HZ2cGpwSIdKgy3r27zDXWMZRbuVXZD/8tVJv1tYXkfFyF
# CVPXAjbNhH8TqVTrDvqVfE7N3La1RBZCbk+RrWxD+CEwq/r8eHv7OV7ZbrRwNLyZ
# qKm4ceqaTzhiZKQdTM4+zqg8lWNz1oZF2ojOFMDqImscjM97LczYVU0w0eAOl1xR
# iPmURXom5km4wI1C9n4peODH8WFpiprHS81koQY=
