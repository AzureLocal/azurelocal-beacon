...
###PSLOC
RDMADetectionMessage = Detected {0} RDMA-capable network adapters on {1}
RDMANotDetectedMessage = No RDMA-capable network adapters found on {0}
RDMAStatusMessage = RDMA adapter {0} status: Enabled={1}, Operational={2}
RDMAPerformanceGood = RDMA performance is within the expected range ({0}-{1} MiB/s) for {2} GbE adapters
RDMAPerformancePoor = RDMA performance is below the expected range ({0}-{1} MiB/s) for {2} GbE adapters
RDMAPerformanceExcellent = RDMA performance is above the expected range ({0}-{1} MiB/s) for {2} GbE adapters
RDMAMultichannelActive = SMB Multichannel with RDMA is active between {0} and {1}
RDMAMultichannelNotActive = SMB Multichannel with RDMA is not active between {0} and {1}
DiskSpdCopySuccess = Successfully copied DiskSpd to {0}
DiskSpdCopyFailure = Failed to copy DiskSpd to {0}
TestFileCreateSuccess = Successfully created test file at {0}
TestFileCreateFailure = Failed to create test file at {0}
ScenarioRunStart = Running RDMA test scenario: {0} (Block Size: {1}, Write %: {2})
ScenarioRunComplete = Completed RDMA test scenario with throughput {0} MiB/s
NodePairTestStart = Testing RDMA connectivity between {0} and {1}
NodePairTestComplete = Completed RDMA testing between {0} and {1}
SummaryReportCreated = Created summary report at {0}
EvaluationComplete = Completed evaluation of RDMA performance
'@

# SIG # Begin signature block
# MIInSQYJKoZIhvcNAQcCoIInOjCCJzYCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCsiMV3d9TVoux4
# VutasUHpBHfcEz39TlK39oKnp5RARaCCDLowggX1MIID3aADAgECAhMzAAACHU0Z
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIDgk4WYM
# M3oS37Ir8GI29Eyr6HA1J8xDn1/Av/f+ry8FMEIGCisGAQQBgjcCAQwxNDAyoBSA
# EgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20w
# DQYJKoZIhvcNAQEBBQAEggEAmOWdf/3Wvxsryu9nd4Hw4GYpGAJn0fgm2uIubjMG
# OuTqJiZ+lYYMRASutOjgtkU24JPogAGiWM+MXBEx+EGEXg6mpokCEiHUAGJUFc0r
# FBXOxh5oURlR3208JN0bXA8pjGNzqMCrWf6JX99+eF+fr6u7wtziGwgN7TsIZBnY
# T2Psd5LAsFPieoHOca7TCpC2kQAfL+RVVksT1zFu1WKP9P8Z5TIBuVWHbE2DIwcV
# ZTRvsPo1T0og+j8Y8GYXuo34GZXWkEeFLczGVUqMXG01l/itQ+x/54MlIEB8zwen
# g2rfG207vBzjV+tTU464ZQLRXY92aWKzPHe/IZuigOJkcaGCF5cwgheTBgorBgEE
# AYI3AwMBMYIXgzCCF38GCSqGSIb3DQEHAqCCF3AwghdsAgEDMQ8wDQYJYIZIAWUD
# BAIBBQAwggFSBgsqhkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoD
# ATAxMA0GCWCGSAFlAwQCAQUABCAk6AJeQqaM93QSbiUAxc2sg6fhxpJQzMqNMyKu
# LpCIxQIGaeexRuPYGBMyMDI2MDUwMzE0MzExMC4yNzhaMASAAgH0oIHRpIHOMIHL
...
# CyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCCAE/SUmVA8xGAoS8j93KNcDBCZ
# h77/5HMLGsIFMalu1jCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIAVgXQEK
...
# OOQNtThs8JIT4pVZxK+0CdTvxImeg/PVxbcwDQYJKoZIhvcNAQELBQAEggIAlJM+
# t4NSRMFBA5Et/uh2gXXqjhxXgYKOmsVguFODb+4mG4n0WYKYHw7ro7HKE5V8zXh3
# zbl4E395cLINwAwOIAVfuJqKph+5nYYy5N68IetX9ChUulmjvdl8V2dCdPJZHvno
# ohv3yP6TvPK3Ac4EHRi/x8XQYx/E4tok16RiBh9yVlSeK46LgWGV82gaE2b0d8Ws
# fBWs0ZSae5zgMbDaWK9e9bmfwGAc0MhZwUwfSeTEVzkOj8V1X4+fT26hiF2YKFbg
# QxEZnz6FE6MwfqRRPoQEtshogENb/bRLS9GqDF5EZQvSHgxOvYUO5lNO9Cm0CCA4
# naMr01IL3rzXIiX6gIu7jVwYNIQHqa43+GqJU20EITcp/yA9h6g1Fv0v8D82GQXH
# zhsf0QN38j7USKVY+xNJp7PdOyNm1RzpSZH+BLBBmqWogaqU5FIIeF3hPyAlcKAQ
# caikXhd5e9nW5gstcJwLqM4SkIXEqP4wfzdKhb+2YCMUuMNBIuAzATyVGqhzTfjN
# x1qVYAjQZJbq4klFW1Sj07lMzRvlfsUiepxF+/rSz+EZT2PrOl3YwLM1VhZevxOg
# Lr3Y+1uiss1mWvrCY4tsgDZ+0LYt4Fj8j6s+DObIBQZo752dfyP5dc5NA3RhvCA3
# UxsEC4G9hy3n/89Z0od9x7VRJWIojXVZ58GwfLI=
