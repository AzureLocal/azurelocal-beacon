...
Import-Module $PSScriptRoot\AzStackHci.Software.Helpers.psm1 -DisableNameChecking -Global

function Invoke-AzStackHciSoftwareValidation
{
    <#
    .SYNOPSIS
        Perform AzStackHci Software Validation
    .DESCRIPTION
        Perform AzStackHci Software Validation
    .EXAMPLE
        PS C:\> Invoke-AzStackHciSoftwareValidation
        Perform all Software validations against localhost.
    .EXAMPLE
        ...
        PS C:\> Invoke-AzStackHciSoftwareValidation -PsSession $RemoteSystemSession
        Perform all Software validations pre-existing remote PS sessions.
    .PARAMETER PsSession
    ...
    param (
        ...
        [ArgumentCompleter({ Get-TestListByFunction -ModuleName AzStackHci.Software.Helpers })]
        [ValidateScript({ $_ -in (Get-TestListByFunction -ModuleName AzStackHci.Software.Helpers) })]
        [string[]]
        $Include,
    ...
    try
    {
        ...
        $testList = Get-TestListByFunction -ModuleName AzStackHci.Software.Helpers
        ...
        $i = 0
        $Result = @()
        $ProgressActivity = "Checking AzStackHci Software Compatibility"
        if ($PsSession)
        {
            ...
            :noTestsBreak foreach ($test in $script:envchktestList)
            {
                ...
                $Result += Start-ValidatorTest -TestName $test -Parameters $splat -ValidatorName 'Software' -EnableTelemetry
            }
        }
        else
        {
            ...
            :noTestsBreak foreach ($test in $script:envchktestList)
            {
                ...
                Log-Info -Message $OpMsg
                Write-Progress @progressParams -CurrentOperation $OpMsg -PercentComplete (($i++ / $TotalTestCount) * 100)
                $Result += Start-ValidatorTest -TestName $test -Parameters @{} -ValidatorName 'Software' -EnableTelemetry
            }
        }
        ...
        if (-not $PassThru)
        {
            Write-Host 'Software Results'
            Write-AzStackHciResult -Title 'Software' -Result $Result
    ...
    finally
    {
        ...
        $envcheckerReport | Add-Member -MemberType NoteProperty -Name 'Software' -Value $Result -Force
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC3rG112JXzPQIR
# SzsH+9Ab5I7C2v/gsDW5zJ3CDP3ZraCCDLowggX1MIID3aADAgECAhMzAAACHU0Z
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIB6Ai4Y0
# QXui/woqWGbCcAEvZMFoABZTMLTnhp5Y7dwLMEIGCisGAQQBgjcCAQwxNDAyoBSA
# EgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20w
# DQYJKoZIhvcNAQEBBQAEggEAXrlwUNDhXL+6uHD0N1aerXdMs4Ts2rHDSptGguRE
# B4oc1lR2uXdDbP/omc4opxUNEEgdUf7uT/GY3AXMWYY3tzY63knDn2asFmXJtua0
# sA4gWWA8w2AUyDksP9w9k1VpEiOYkJ3IF3bV+pass8RyFrGcln/MsazEgDdur8FB
# obNELWJJZjSLnMcH20OL4lc4rimrfoGsB8Jipt94gSdPHrH27lPI5Q8cwW8Q2lCJ
# jw596xbCVqTV6IOrOCI2UlkcfDIKOjhQFXgpSmZDhxfdyK0335fkmC+2U0cMydTR
# zMe3zojreZXYgYigxlsQyBdDjzveHvr76fKS622l0rKBmaGCF5cwgheTBgorBgEE
# AYI3AwMBMYIXgzCCF38GCSqGSIb3DQEHAqCCF3AwghdsAgEDMQ8wDQYJYIZIAWUD
# BAIBBQAwggFSBgsqhkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoD
# ATAxMA0GCWCGSAFlAwQCAQUABCDrCMCzT3UhC4TJL8zld5gPk+VvdOlLAUTqXQ/z
# D35GtAIGaefsSb9NGBMyMDI2MDUwMzE0MzExMC42ODdaMASAAgH0oIHRpIHOMIHL
...
# CyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCBO/UrUn3wGSyDBt9AYS1I9FyfC
# L0g8vHdjZfHnAGzSHjCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EION7vyOl
...
# CfUpoXjUtBZKerlMmArdnX03kdlRHISH7mUwDQYJKoZIhvcNAQELBQAEggIAZM4e
# bXdKoaxwAy8FWrvejxhX1qsJrr2RwINoTzXmBEp3eTbksWOvSlo/bmk5/jc8nLTs
# NgJXzb5DMpnEmFjeI8lNOcDD4WlyB6Iq4KmMFjPlkzeFcAWRtS5Ry4zsUyFbmH9+
# xorcW79eF3UlT6DvfSKyju04nCMBMvkSKHSUvuXqg17HUJV6ulW6+ZOpeogZQbkt
# ujcoHfnQOpGzw9SgGPPTbpIg3KlKxoQnSSLBMu/4GXBCboc/Y48kR7p4BgDjWQC0
# +wEOlEHHVGVr98qOn8YpZt9XBL+HQ+/7J7pKpbntyZZmYxNPTkKrnfwIyDzPF4dF
# kAbyb7OkHMauSxW3xfWQfhf+EjmlvsGNUkAlq0ICYi0F5qbfRxl/tyWYPk9N1WcD
# /7UJFI3v/bPvEEHHPtiLyxX2MJufPBrEM2FzssU0/eeiA8hf/JWObsoFxJUr+BmC
# /TblcxJ2qWKiKAZJ7GZMCHhbN37zNhXEd6ATu0UBKE8JVl+mzpO933RMzgvOfdXm
# 1Bkq8NWl6otCBIk/vqErJV6b8JbfjF7s7gSavwVkRQqNTbFJgieGuZZbX9NY6PAw
# ZIZKWeIuWuRn+G4w2BRXuHFI9gU2Ew8kwjGJpeCh+0VDLag8MUWGE+EwBxqKQ4cq
# gBJvawTfgLhZcteHUpOCJaETvBEqbz2ygSdO2DU=
