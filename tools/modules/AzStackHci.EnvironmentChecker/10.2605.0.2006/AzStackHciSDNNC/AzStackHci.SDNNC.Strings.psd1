...
###PSLOC
TestSDNNCDeployedTrue = SDN Network Controller on Failover Cluster is deployed on the cluster nodes.
TestSDNNCDeployedFalse = SDN Network Controller feature is not deployed on the cluster nodes. Follow the guide to enable and deploy it.
TestSDNNCServicesSkipped = SDN Network Controller is not enabled on the cluster nodes. Skipping SDN NC services health check.
TestSDNNCServicesTrue = SDN Network Controller services running on the cluster nodes are healthy.
TestSDNNCServicesFalse = At least one of the SDN Network Controller services running on the cluster nodes is unhealthy.
TestSDNNCServicesRemediation = SDN Network Controller services are not healthy on the cluster nodes.
'@

# SIG # Begin signature block
# MIInbgYJKoZIhvcNAQcCoIInXzCCJ1sCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCxBf3w3oiRfpA/
# oxmKwA9LnKC53s12ZdFHOb4obnLOfaCCDMkwggYEMIID7KADAgECAhMzAAACHPrN
...
# hvcNAQkEMSIEIOvhLFTrzDgNKHDjOf4fYMB18Ap9i9Leb/B5LOwsIojzMEIGCisG
# AQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3
# Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEBBQAEggEAmZ7lJ3SihlpoEWOtVwk1
# wkw+z0Y5pAcG2vi7k+1kHJnGcAFK4ZeDSwBEs9aWU0PsvF0Rlw8rJiiWz91zPhpj
# 8gq/bF/IMU82wSgHvGfPkwj50SVwVUnd6erwCYXid/ObsscZA79Yo84tZ93ZfCvf
# LRqfVdLjDRB2yccFWOeq8d4rqMJgvnr842c8JcjbJRIdMhNi0K+hYBhCcjtzPNbJ
# PdqZUJnNNtxCWVqJZ+8Es2W8jmzymuFVkaRKdYvW/e3BSs2YCIdMypnrnFnMUJ8O
# LjEHxGOCL9RJZzPtp+k4gslRkR0VZgrhAN7k/B1Dil3LTCrnh5JqoCXCo4nB4wi2
# w6GCF60wghepBgorBgEEAYI3AwMBMYIXmTCCF5UGCSqGSIb3DQEHAqCCF4YwgheC
# AgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFaBgsqhkiG9w0BCRABBKCCAUkEggFFMIIB
# QQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCDzUCMolvA8R6UdIsxu
# cc2Kdu/aJH+pZTSjzfqacIpnzgIGaewquMvNGBMyMDI2MDUwMzE0MzExMi44NjNa
...
# BDAvBgkqhkiG9w0BCQQxIgQgPewvOabLUIEEgnVNGQecGRc9fgBfNfG+mto6lERB
# FCQwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCA2eKvvWx5bcoi43bRO3+Et
...
# ptLeODyj6FjPBUD6JIKNMA0GCSqGSIb3DQEBCwUABIICAJKP285vkSSrsqvKqVXE
# nBRgrXcWV2uYP5tJApl1mJHnvEGndwC8QPMAK6ZsbO6irM/vLIkWtOeXU5kA/6nf
# 9PnAdIl6AIbyLDokraRs7267XTNAxEG2Zb10zVFcJ6cANAO4xqKYHHhwVIGamRd/
# Qkk87L1qDCRn6nXaoGMHgF6p7nZaTa8ty/1U0zGwYqC85Y2MPPc8OHed6sZGk+8O
# soKo59W01wNWvcJ47wq/tySovBdAUR/iCdHcHBFcgWP/q3d7EmuPLQbO4EW3zZ0B
# tBp/4/KqaBv+52Elvp03fTdpEpC2hhdeQxTSEPO6Ebs2DqSVNnoM2VurzN0WomlT
# 4ub0l1LorYmWrwNsKRA97NVwPIUbS1i5OyTURZUh8Nq9KyrAq+EueWvsLyueUKXq
# h1Y+vFjFN0d9pTVL3UkhuGavsdtfWAL7P/iNy02+c9dW6WDyXdFsd5g9qcR+Wq3W
# PHCRB5XeEjG5YBj1rRLCtgf6aPHShk+YPFtoERWoj37do2GXyuqJPqv4xj6wotbt
# RYQv6CR9J2mrXGIPU3He5jGqM3dNRy4IRo7xbi3++LNvRWhIh7XOFtl+XI1pKMkE
# 5FZD4MNIrXWbRQtJlOTPfMCdZLF6PhhtcjOYn6di5/kq7V+KCEpmfbVzpZtggHix
# OkIgPt44sZ32xkvaHjEak5+L
