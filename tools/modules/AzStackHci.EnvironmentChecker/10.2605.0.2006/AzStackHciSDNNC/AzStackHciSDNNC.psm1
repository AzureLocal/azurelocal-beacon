...
$MetaData = @{
    ...
    "UIName" = 'Azure Local SDN Network Controller'
    "UIDescription" = 'Check SDN-NC health'
}

function Test-AzStackHciSDNNC
{
    [CmdletBinding()]
    param (
    ...
    try {
        ...
        # Note: EnvironmentValidatorImport is already called by RunSingleValidator, so no need to call it here
        ...
        Trace-Execution "Calling Invoke-AzStackHciSDNNCValidation with resolved parameters."

        [array]$Result = AzStackHci.EnvironmentChecker\Invoke-AzStackHciSDNNCValidation @invokeParams

        # Check if the ParseResult method supports the Parameters
        if ($Parameters -and [EnvironmentValidator]::ParseResult.OverloadDefinitions -match 'EceInterfaceParameters') {
            Trace-Execution "ParseResult method supports EceInterfaceParameters argument"
            return [EnvironmentValidator]::ParseResult($Result, 'SDNNC', $FailFast, $Parameters)
        }
        else {
            Trace-Execution "ParseResult method does not support EceInterfaceParameters argument"
            return [EnvironmentValidator]::ParseResult($Result, 'SDNNC', $FailFast)
        }
    }
    catch {
        Trace-Execution "SDN-NC Validator failed. Error: $_"
...
Export-ModuleMember -Function Test-AzStackHciSDNNC -Variable MetaData

# SIG # Begin signature block
# MIIncQYJKoZIhvcNAQcCoIInYjCCJ14CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAyBifAjE8DCcHZ
# vFsX9+sDNHUvAqPy08KJiHDQGGc/xaCCDMkwggYEMIID7KADAgECAhMzAAACHPrN
...
# hvcNAQkEMSIEIK+qGXpiooS/gGtcnSwCVA0b7VewD4+8xhQrJtt/524JMEIGCisG
# AQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3
# Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEBBQAEggEANu0GlWQsjzxlE/IWPpXw
# 7xu6rMyC5C2eXK8G+tMdDmII1CIyOzLq7gTuUHpJABERNgDC2BoFy/XEiHkSXHts
# ekjPokAgc5kRH+F8qxRV1HTJV7Z16FlH+g7l9pw4xlVUBt7uoxEc29w4zDjq1RRQ
# 7YZCJy40tke6LI/1QXQmio6zcDcZtvaacYrBdbUbYarnWUuYhZH1rHD6/00LYRGN
# rTfYTJa5GOba/IObVisSpjixZQXaqGR2UFjdHJNWIhZLdnRlFM6O4PCe/64bx7d7
# 45i++UzReab+tIyWeSmT0WTLv6cyOGeTbu/B8Yauk2bG1K6hRSRA+PswGnD+312c
# 16GCF7AwghesBgorBgEEAYI3AwMBMYIXnDCCF5gGCSqGSIb3DQEHAqCCF4kwgheF
# AgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFaBgsqhkiG9w0BCRABBKCCAUkEggFFMIIB
# QQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCCtNZvWKDF4nj3gFpYK
# aQUIFL50YWmAOYb6rKK1DPwj6QIGaeugEif9GBMyMDI2MDUwMzE0MzEwOS4zMDRa
...
# CRABBDAvBgkqhkiG9w0BCQQxIgQgNPTM9HxsK7spK8/qM19vR3ZjxH971EdZRnny
# At52heowgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCDD1SHufsjzY59S1iHU
...
# CJI5L5fhiGpS2xzTAo0XyaBPMA0GCSqGSIb3DQEBCwUABIICAFGY0dMUVx6IGIFh
# iiIykjpPsgnQvuj0nTDk5UbCx2IgGzhPChFJ7IS61YqqdHFNTjoy1zWp4ahxhH0e
# VGeULpksenMTAVA6+JTJDNXn9i1tqcf9Y1it25nzt8jKrK/zKb5iirU7pvexks9A
# FtAohgFSco1OPnDwIvALxArbkvZHJPDt3uGU4AXgvmPBQl7VbIwFPPsq25MxeENf
# ihpNLhYLtMsfqXxu5hfGVv0v8v+HiMLkFv8Hd/LyedUwB08Ly/zuJYKpdciW/VIR
# KircnE4R2felVMNlz8eb6PKDx0beOTFZqvYt0OHqCwYbeuBD0IEB3cEegH39LtHe
# KVSEXtsAVdvPw6Dsk+Ps+PegpgvUiQO/+1iRutAeacG9+mnhuPOodx7y7RqKHMrA
# pugkgbbK9/7qc3vuGeFfbG5xX4mmf2SZRZ/MsLPHqPt7jmvpIKmCEnDBTOhW8RHp
# Z7upN4jj59zch3wIi0/x3kBf0BO53EcSDaExsQN3DO/l4QCfDk/HLX32XPmwX3sJ
# T5OVykgPMlZwYWhm7P6fOuKN5+BIahIBsXgTns2HLbnd4WtbhRy+cBHD5feuzYAq
# cu0PDOwqXKjHh6KP9vBE9v0ySxM+vuf7wka0oEMgcnOVBdAl1qUcr0M2LNiTC7hP
# dyd4zTst+uGWe2xAjt89H12607l4
