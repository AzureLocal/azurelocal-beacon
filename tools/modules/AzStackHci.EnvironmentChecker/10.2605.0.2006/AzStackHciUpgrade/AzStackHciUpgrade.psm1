<#############################################################
 ...
 $MetaData = @{
    ...
    "UIName" = 'Azure Stack HCI Upgrade'
    "UIDescription" = 'Check Upgrade requirements'
}
function Test-AzStackHciUpgrade
{
    param (
    ...
    try
    {
        ...
        if ($OperationType -eq 'Upgrade')
        {
            ...
            Trace-Execution "Trying to get IP pool information from ECE parameters for upgrade validation."
            ...
            Trace-Execution "IP Pool to be checked:"
            Trace-Execution ($ipPool| Out-String)

            $allIpPools.Add($ipPool) | Out-Null
            ...
            Trace-Execution "Starting Upgrade validation, detail output can be found in $($outputPath)\AzStackHciEnvironmentChecker*"
            $UpgradeResult = AzStackHci.EnvironmentChecker\Invoke-AzStackHciUpgradeValidation @Params
            ...
            if (Get-ItemProperty -Path HKLM:\SOFTWARE\Microsoft\SQMClient -Name IsCIEnv -ErrorAction SilentlyContinue)
            {
                ...
                $UpgradeResult | Where-Object Name -eq 'AzStackHci_Storage_Test_Storage_Volume' | ForEach-Object {
                    $_.Severity = 'WARNING'
        ...
        if ([EnvironmentValidator]::ParseResult.OverloadDefinitions -match 'EceInterfaceParameters')
        {
            ...
            return [EnvironmentValidator]::ParseResult($UpgradeResult, 'Upgrade', $FailFast, $Parameters)
        }
        else
        {
            Trace-Execution "ParseResult method does not support EceInterfaceParameters argument"
            return [EnvironmentValidator]::ParseResult($UpgradeResult, 'Upgrade', $FailFast)
        }
    }
    catch
    {
...
Export-ModuleMember -Function Test-AzStackHciUpgrade -Variable MetaData
# SIG # Begin signature block
# MIInSQYJKoZIhvcNAQcCoIInOjCCJzYCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCTgpC6yo51UVK4
# ofCjyokwKB/1nGuvUXULG92RfMRLE6CCDLowggX1MIID3aADAgECAhMzAAACHU0Z
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIGOp0HRR
# TvRUB6wrDXdOrnJTLyw81+maJz1Y8yHYrlBQMEIGCisGAQQBgjcCAQwxNDAyoBSA
# EgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20w
# DQYJKoZIhvcNAQEBBQAEggEAoRWGGXSnJudXsK9FK0GuDNiYJkkpn2kDBbUXpZdN
# 5uXEzMdhqo7k5hdHq4cb6TLm9LvhxzpyNo/NWhwYz1dexMzo6R6jw590sC0nSIeL
# 0sJ5aybKMFJDRRD/eI2Y/hfqDe1ZGxAOPnSeM/GpOu7ZGTO7V+rCelKws1YRRzNg
# Zndu14DwkDnHn7wAWWpcx1KUuQJ63MAsnJIzdSvp9IKGtXj9EdG0RFUT+ufuBS8f
# f+hhVVpxTFzMwUCWed9KRuDTBrW5fwFhrrOxCEqaEOOf0WAb/QclCt67SA6DDBSh
# 3tmruwgHec1uZmS2+XJmKSYVrD8Hpe4j8B+/M1B6MkHhjaGCF5cwgheTBgorBgEE
# AYI3AwMBMYIXgzCCF38GCSqGSIb3DQEHAqCCF3AwghdsAgEDMQ8wDQYJYIZIAWUD
# BAIBBQAwggFSBgsqhkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoD
# ATAxMA0GCWCGSAFlAwQCAQUABCCO/+yp1ChQRb+xxOpXUf0b2fAEie1BFSLbQbII
# d+6y9AIGadfEjs1AGBMyMDI2MDUwMzE0MzEwOS44MzNaMASAAgH0oIHRpIHOMIHL
...
# CyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCBynqzO0Xeuxpp7jCqWxWr61/bK
# S79/bZvSRjKjiRg7JTCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIJbwMywR
...
# fcQnnQptmE1wsN7QTb6Exag5U1V1RqiSX9owDQYJKoZIhvcNAQELBQAEggIAIp6K
# qMZJwtQgN384RwgrFdwv17rTx2V6VOvvfwMdzP8yy4WM45cg2dfKEH3M263ufvNA
# fOgiWzk+ux/hZMvsb/FlDuGPI5DlMsWz7qHCpudrAXHnfRQg/0tYIhjkobbAPlgL
# bG/2GCakcDsnQL9DLYmPJx1cM7g7INW3CyaHSdBeSsjmB6gPJIiSH3NQoqaMGXZb
# CSe0r0lRBTyk7UoFnan/dSV/VMFOVqF/+BZmxip1OnEDL3+HSJGEUcZsNvm6fH8m
# NelvrQ5WHq5ExHSEIbL5epIrOlDFW3y9EowtHDBl/dvkm8+Z5ejXDXEZ1OXOC9yJ
# NuOfqnJHaS2wlIAK0UkU0/8S9I/KLYh6W7IiwSwzoE481J+YHvxHfdRlIhEYJUUN
# E4eokX+b4J92mmpxb9vxSQ2nePuCIzkDHWQ+HyKn8cqZLgz0Bbh1FFJ7/EOHTgph
# /Zv0DSzHIO5tqX5geD8glP0WkPqojh2e1vlnSW9GyHQ53yHccT9hwxrDEzyr0LKz
# MyLevR/N1YlFj+wqlfvpBdx4A6gDCk/MB+XpggvUtCOwMZHujnESPJ31AxD1Tz2L
# 3ov6nSDPFpR+iI8kXjPIUFSF6m6tAXfDLNYq6UaehOVp2Ur8fvdk7vzjGYHMTOMU
# nE2bKmNkxVt9S1bbY4DLJrmBFUz9LZZRZ8oucA0=
