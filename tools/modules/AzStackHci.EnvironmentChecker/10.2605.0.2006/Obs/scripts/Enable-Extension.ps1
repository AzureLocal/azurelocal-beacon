##------------------------------------------------------------------
##  <copyright file="Enable-Extension.ps1" company="Microsoft">
...
try {
    Write-Log "[$functionName] Entering. Enable script started."
    ...
    Write-Log "[$functionName] Exiting. Successfully executed enable script." 

    Set-Status `
        -Name $WorkLoadName `
        -Operation "Enable succeeded" `
        -Message "Successfully enabled extension." `
        -Status "success" `
        -Code 0 ## PS Success code
}
catch {
    $customErrorMessage = "[$functionName] Exiting. Failed to enable extension, "
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBdSMcStwmVgFyH
# c3f1hgKPhUI44r5r6njvQ4iXXAC7UKCCDLowggX1MIID3aADAgECAhMzAAACHU0Z
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINo+i1rl
# BvtHRfwCzwpEd+aL9QwOhyfRXexSoptfGHcVMEIGCisGAQQBgjcCAQwxNDAyoBSA
# EgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20w
# DQYJKoZIhvcNAQEBBQAEggEAPgzosJjE6MzOPA0aogYnd+ApIMeCWmsXqyeDJRbR
# Z949H6JZEtzDqLgjYKYi0jv1GK2imTYCSKW8XlDekH58Mcc4Cws0nu3pRVxovQPB
# ZxqCPLKD1CFne+f7yu5hH7lTKe6zx2Psaj9C7lNsmxH+W081k+i1FP1pOHYIuDv3
# vhzEpk40pElCYL92spxphOqrR7AgYc38yERHQwKIlgPcgc6R5oMYxw2Jg1DxTGBe
# MfGqRgfeBvThtQYY9g7VTCjlDPD+yQx2pITR5YoTiVzrDW0srEk7rfYaqIzLywiU
# RnKmSUiQY9qifHonUh/snYRCYz5fm0vntetTJg5EuLUpwKGCF5cwgheTBgorBgEE
# AYI3AwMBMYIXgzCCF38GCSqGSIb3DQEHAqCCF3AwghdsAgEDMQ8wDQYJYIZIAWUD
# BAIBBQAwggFSBgsqhkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoD
# ATAxMA0GCWCGSAFlAwQCAQUABCAte8XIloytYwMEsde599ckcvcUnpW2TQcxAgFI
# MtbbtwIGaedcMrdLGBMyMDI2MDUwMzE0MzExMi40MjRaMASAAgH0oIHRpIHOMIHL
...
# CyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCBQOs1d0C7Dx9FkGC8XcU14KZyA
# s1aELnBRu2oKJhw8cjCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIHIOI/Q/
...
# x04J9mIfST2NDYTqeHpS2VK/0b1JF/5aWO0wDQYJKoZIhvcNAQELBQAEggIADBpE
# 1rISeIwaQYS0uNOGs37XQCeekxQGCTdymm7lO5pJP/0F9vGlrgGtsZ4aUGnRwftc
# bvX+yizRkLnpb5n5vofqchVSETvpZfto5wxd0AWb+8Gd9g8oDyRzwy8cgnfK07+K
# g6ML4ZxVpz7RA61b3luHCM5gX/uWz1g5/HnYbkw1Eaw2SgncwACEVpgkK5+8phdd
# RJJk4sBaauk3iydqLha21mpXAChnITP8PI9UfMj9/6ddja0s4G2xZeThYk/lW5gw
# 59gS13AGJtV8DZ9sTIC7BVOFkb7Uw0PITVxI6RpFLmmvE/cjlO6+zPs8p41YTj74
# y4ONQ4C8FDa+YYmPpdgiPf9j8JH2ZQE/1rosVeHlP6Gff6dEWHkjPjVjvgQ0XDng
# 9R4xOn0J51NNE9B/sZnYiUUaHmyCWP2m1h54uDbCr/kOU261PWFuQbrv+Pt72lto
# HgPdblNX803MA5TG8Ao89NimFsaQ3BriDBglxmvrYnLkS65ovP+iHo6gC7VSFzp9
# mirORxm3Zvv2XWKVqQSrMwziCF01JECvcrM8wN7ny9QqvCE/8Rsk9f73XYscJu2M
# arknWrzXnWpSgFgP3TJjexOAKeUpxPhWmaANwHLP/+wEw6k4UFaMWi5M6IH1q9KP
# gwvKFWFqiukTb04aVizvUBeoYWf4WeqzV1Devds=
