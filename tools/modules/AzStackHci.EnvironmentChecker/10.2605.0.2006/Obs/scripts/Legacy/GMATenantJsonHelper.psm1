...
## This file is to support legacy Action plans which call the TelemetryAndDiagnostics extension only.
...
$global:MiscConstants = @{
    ...
    ObsServiceDetails = @{
        ObsAgent = @{
            ...
            BinaryFileName = "DummyBinaryFileName"
        }
    }
}

$global:ObsArtifactsPaths = @{
    ObservabilityAgent = "DummyObservabilityAgentPath"
}
...
function New-CacheDirectories
{
    ...
    Write-DummyLog "[$functionName] Entering. Legacy call to $functionName. Returning dummy value for GMACache" -LogFile $LogFile
...
function Register-ServiceForObservability
{
    ...
    $functionName = $MyInvocation.MyCommand.Name
    Write-DummyLog "[$functionName] Entering. Legacy call to $functionName. Noop. Params: $($PSBoundParameters | ConvertTo-Json -Compress)" -LogFile $LogFile
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBGATeoZf++qF3b
# ktYNvIv+xrD+CYKQBh6y1PdvhE5dmqCCDLowggX1MIID3aADAgECAhMzAAACHU0Z
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIO7XF4tw
# ZAKat2TRr1SnkogxNJrVSSGfjAksPUAaUs8QMEIGCisGAQQBgjcCAQwxNDAyoBSA
# EgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20w
# DQYJKoZIhvcNAQEBBQAEggEAip1ISafZBCXfdd2vv5k9Zf2PEieG+bieVmZ4fmu/
# s/BzP9f/g832rv1ft4ZFqC9fsQzd7AdEkKCDox0i9wyK+Pf3Twr90Oxg/AsOH0Jy
# 7eOLumYSUXMhbrM9HWwOY08yNQkqGPZ0Wv2CxowbgrN/wE5ADyBpwbTW2hapu1xd
# qvbSweQLiaajizAcC1YY/v8qZLipeAvh9wFsgiV5Tj2F8EkVCDU9vnkJPi2vLjZz
# NiwT5l5BD1AOpauS3ZlrqA+dvnngopqd3iTpaOI164+DPytpvLOQJ0m6hfX1XftW
# dxusvyAVFMoGqcfZk4SsJE0kzMuRVnFmYDZizmGFW83OPKGCF5cwgheTBgorBgEE
# AYI3AwMBMYIXgzCCF38GCSqGSIb3DQEHAqCCF3AwghdsAgEDMQ8wDQYJYIZIAWUD
# BAIBBQAwggFSBgsqhkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoD
# ATAxMA0GCWCGSAFlAwQCAQUABCATjtH1cbNcM3y2hz9UbvmBl23ilhXwv0nT2xSf
# yhRWvAIGaefsSb8/GBMyMDI2MDUwMzE0MzEwOS40MTdaMASAAgH0oIHRpIHOMIHL
...
# CyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCAmHEAe8ddiS4h9MUH36i+9rFaU
# R4JVZli52x467cn5ZzCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EION7vyOl
...
# CfUpoXjUtBZKerlMmArdnX03kdlRHISH7mUwDQYJKoZIhvcNAQELBQAEggIAxRE1
# 3fVoZ1qD0qTU1ysaI5RRlf7LYeg7YltT06VfqQWqTk0gEpgCC16KPMGLi3R/MXOV
# 7MuQbkay8/Hn8amA6o12TfttMe9kErAhtCLYqmn/dJAnmNi1nfR3++1Aohjn0QNN
# 30Ft2g4yvQW7m3VP0yFqWhvE5e4kwFHnXdFMNDy3bEoi0J9hRr6sUN7iPxB3DouR
# X403PODXxpFrwNOJFvTuhb51HczePKl61qPdFK+f1r7HuKm/u+Ol26dJpulKa3iM
# e9gN6lhUJOgg8d/km3/HL+GQ26ysR1npvlgGH8VsT5sBD6+5PxckOQNTXlJ50OCn
# rNjfAeV/cO/dcPGqLZG5T4n7MIfuXbV5gLsFAEOuKmGtlklpuM46wLgmp7GDbvI3
# rIH58pFv2JJc+g0lu4yynKIGXSJekfSXkF7VQowa5tHiuB0Zlb8jlEjAhSq6lHwz
# aaUMEjVj7SEGdqKE2mza3c+574iZipoC5lHJrw8x4qDTVoFqJIkLM+zrfEoSwYPL
# M+oUfkhRIv56pbzVLNJ3NYR5EneAhjmJdmO4u8SLNK8WAR6iWsc+cOsqfzUWtYPy
# MW6XwMpV/GjbLMOmqQeY3mhOlhSK5FH92CdOuRFvE05p8x6WHfQjbbBzH+7WAv1c
# ooUXVNuLbN2CeoMcRZWq3m/pkBcW0iC9rwRNGJo=
