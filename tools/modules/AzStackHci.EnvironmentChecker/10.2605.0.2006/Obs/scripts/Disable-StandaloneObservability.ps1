...
$workloadName = "Disable-StandaloneObservability"
...
try {
    ...
    Write-Log -LogFile $logFile -Message "$functionName : Disabling Standalone Observability pipeline components."
	
    & "$PSScriptRoot\Disable-Extension.ps1" `

    # Disable Parser ScheduledTask
    ...
    if ($tasks)
    {
        foreach($task in $tasks) {
            if($task.TaskName -eq $PipelineConstants.ParserScheduledTaskName) {
                ScheduledTasks\Disable-ScheduledTask -TaskPath $PipelineConstants.ParserScheduledTaskPath `
                -TaskName $PipelineConstants.ParserScheduledTaskName `
                -ErrorAction Stop
                Write-Host "$functionName : Successfully disabled scheduled task $($task.TaskName)."
            }
        }
    }
    else
    ...
    Write-Log -LogFile $logFile -Message "$functionName : Successfully disable scheduled task with name $($PipelineConstants.ParserScheduledTaskName) at path ($($PipelineConstants.ParserScheduledTaskPath))."
    Write-Host "Standalone Observability pipeline disable complete."
    ...
    if ((Get-Command GMATenantJsonHelper\Get-ExceptionDetails -ErrorAction Ignore) -and (Get-Command ExtensionHelper\Set-Status -ErrorAction Ignore)) {
        ...
        $errorMessage = "$functionName : Failed to disable Standalone Observability pipeline components. Exception is as follows: $exceptionDetails."

        Set-Status -Name $workloadName `
                    -Operation "Disabling failed" `
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA8fh0h3kr+zwGN
# D+1dy0SWFXjkxzR2sxGjK05h5on4HaCCDMkwggYEMIID7KADAgECAhMzAAACHPrN
...
# hvcNAQkEMSIEIBg0GXksPnAukTEcZY4oVA6B8Y34A4p16KiFQseFUVPdMEIGCisG
# AQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3
# Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEBBQAEggEAdB2pXzO/M7qaU2IVAYxd
# qziai/3Vz7iXIYKNWGop24/oc8Z3xeDO6JL30Lcgf6N9bXeLH6xnG7k8keqYhRfy
# lN1LXqEB2sMYv0ke5MfpDrCyfsDDk2uYmWReLJQMY/CsFNnx2GZqG5/lMvu9XOqx
# DsTboGiZSaMU84kMYefy58sefcEXuiFZD8NAqZEnJW2EiSlBC0VQ0O48f+NugY1V
# 3ZXEfBMNukEQkjhM90M4UvKiOk8lDkdNipkipYkRTKttW51q3SfhTqb+UTvxJPOV
# gvau1pzJ8UK49xBHKOCLv8yL7495RtE0vptQlaGDY+fgnF1sL33fFhHS5TcvSPvt
# 06GCF7AwghesBgorBgEEAYI3AwMBMYIXnDCCF5gGCSqGSIb3DQEHAqCCF4kwgheF
# AgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFaBgsqhkiG9w0BCRABBKCCAUkEggFFMIIB
# QQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCDNg4CvH7fZAbf7IwHF
# lc2o0IaFpqowoHARcARArqrC2QIGaeuJ1G3KGBMyMDI2MDUwMzE0MzExMS4xMzJa
...
# CRABBDAvBgkqhkiG9w0BCQQxIgQgz7lL8g93Efvz+lojADbkbZJh3iO7EBY3b+tv
# OnE9oY0wgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCBz+X5GvO7WngknH4BZ
...
# fhuOdJ2Sj9gOYyp366y/mz5vMA0GCSqGSIb3DQEBCwUABIICAGws1vqyIua8RjwX
# b19KjJ00+w9mv0NdnunjnBqH2hh9KSXgz9obtGO37LupN8p0ug3goDl5SCn3mwmr
# GPmQC8p7FVlquHUTUswkxJdXXAN7Rbs9gfK3W9mAe7d4L0RqjJsMpILFAfG/0jOQ
# bWXHcgjVfr0QHjEVVFa99kZpefMf+frLpYrPUZ+SICP2TuiAg7P3WFhQyEJLIovU
# YAEgjNtgMvwobbXK2jpfTXHUhZkoOEG6VCr77xUEKEx6UeCqeV7hBI864cWm/ypn
# eQx+/0gYcDq0xZ6MNs7uYCv7Vixphs6K2eNyo6CvJPsjTzMrreiO4Z/hy2+PGdy5
# M/Pd2MOmKwFK+UjIHpofVPDdHDHM4TfC2fJhnNUp3jFUu60lvnr2CdYezfHPjdfs
# xNAQmuM84iwWqcnnIN7iRdhIAobBEdlPpgjyeWzgwihRAjNHwLo2Cuj5+J9DEdzn
# 1rKVhDvnZT6qHWTqXt0knKhwMysbDl/ggqJTv+M6U6L179PpHbmmZXX347p9gPI/
# r/cFng3YXBQMrz+RNf7vx+BiIo4vfdemvtjwVUpcvhos9xfJaQaTwTn1Luy/zQNz
# EGP6pVvy/QGfiTBlawMxhRQj96HtlvhwGqe/f0/RnrDhwIj8FA6k1nosv5crle4s
# DqffLGIoSjUnJR89I5POG2tAVpCL
