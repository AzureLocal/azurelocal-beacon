...
$WorkLoadName = "Uninstall"

Set-HandlerLogFile

try {
    Write-Log "[$functionName] Entering. Uninstall script started."
    ...
    & $scriptToExecute -WorkLoadName $WorkLoadName

    Uninstall-ObsPackages

    Write-Log "[$functionName] Exiting. Successfully executed uninstall script."

    Set-Status `
        -Name $WorkLoadName `
        -Operation "Uninstall succeeded" `
        -Message "Successfully uninstalled extension." `
        -Status "success" `
        -Code 0 ## PS Success code
}
catch {
    $customErrorMessage = "[$functionName] Exiting. Failed to uninstall extension, "
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCxt+WeUN2B1miW
# IQUhYI2L7fl3oVfV+Q7LbZZkbSSRV6CCDMkwggYEMIID7KADAgECAhMzAAACHPrN
...
# hvcNAQkEMSIEIIqeYNrGnbP2o59aPPwOgq0NGsMpEcNlhHmH19mX5qrNMEIGCisG
# AQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3
# Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEBBQAEggEAk3frDT/kK1oet3EsoN23
# ld3gqx2/JUpuUnryABCqaG2uiCAQj4ycxMrkikvw+80PyB3QWEQCY7iLcJ/ijgzt
# kEKLVCUCFP0tWGxs9NGN3Te6b2HpIocaAjXqzYrpThu+pNNYsuKfqQoOSBsA8xa3
# QkboW6KIiMs8lREJ2XOv7w7DV1DINsi9xhpsRH/7eepCMNOBqkKBmb3dbY2yrP2m
# Q1EEddjA50DmGVfnF3ONb57gQglzqzHtacPG+PVaD9IJpYZSHUEmeVFjGNENLm1w
# xCqW3L9Ucsb2XLucy7Zta7eO8rJ+Q2H8e0Y3GDOh1DnMkFpPZiQkfNw3R9ROpfqL
# waGCF68wgherBgorBgEEAYI3AwMBMYIXmzCCF5cGCSqGSIb3DQEHAqCCF4gwgheE
# AgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFZBgsqhkiG9w0BCRABBKCCAUgEggFEMIIB
# QAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCCALLZBRZ/ZPP79nthL
# 8kebeccLUVagmL8Wa5UnoyixgAIGaeuJ1G59GBIyMDI2MDUwMzE0MzEzMi4yNVow
...
# YW1wIFBDQSAyMDEwMA0GCSqGSIb3DQEBCwUAAgUA7aE8eDAiGA8yMDI2MDUwMzAz
# MTYwOFoYDzIwMjYwNTA0MDMxNjA4WjB3MD0GCisGAQQBhFkKBAExLzAtMAoCBQDt
# oTx4AgEAMAoCAQACAipTAgH/MAcCAQACAhN9MAoCBQDtoo34AgEAMDYGCisGAQQB
# hFkKBAIxKDAmMAwGCisGAQQBhFkKAwKgCjAIAgEAAgMHoSChCjAIAgEAAgMBhqAw
# DQYJKoZIhvcNAQELBQADggEBAChvVyICz0SeSW9/GyNG7GfUReDHg050twrA7uv+
# bXRC4bDdwOcrmPCFQ1Z0x66sh7h3bOhXCUmCuwVVNa/6e9nJYyWeYMRT3y9pJ/Pc
# lXZXQ1XmSQVek8emAB8e372wQJ1KzRLk0EPWzonTWCTafmS5im9nHCF2da4+B3YR
# T7unoZ6awQrqcVHQGcJBm4x6Y2oSh4AD2L5Wr14x/vNrPsk9M9IOb4iHNhK9U00p
# Kpmg3Hqv3R7zW6puMOql88fxcpoP0RMHVH+UeT1triH0uIwqVLSlyf+EJ9Je+UwN
# O1GTvEWBTXrAZOGjcdQthW1AYV0LofTogaYK2lOF3UK2MJ4xggQNMIIECQIBATCB
...
# EAEEMC8GCSqGSIb3DQEJBDEiBCCy3soTAq/XGDXZgVlXyP9cW/RtII393grpEqnG
# 177XVDCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIHP5fka87taeCScfgFl5
# hT4HMEvUnLmgnzBWVM0jF9iDMIGYMIGApH4wfDELMAkGA1UEBhMCVVMxEzARBgNV
# BAgTCldhc2hpbmd0b24xEDAOBgNVBAcTB1JlZG1vbmQxHjAcBgNVBAoTFU1pY3Jv
# c29mdCBDb3Jwb3JhdGlvbjEmMCQGA1UEAxMdTWljcm9zb2Z0IFRpbWUtU3RhbXAg
# UENBIDIwMTACEzMAAAIS0QgGPMoYT6oAAQAAAhIwIgQgfrYLc7Kwmkv4g3CQpJl+
# G450nZKP2A5jKnfrrL+bPm8wDQYJKoZIhvcNAQELBQAEggIADCBD52HPZYj5ZIvH
# kWkqEZ6t6S+Poa7FVm29BLDk3hLtp/ozihpYQP/TlwxJKdYE4bvhDnh20XyiRnoc
# kq9KOtWnN/RUghxoan+KfjwJm8GWw2rIySap/ChKid5YApKH6vRVksCvQyY+nBn4
# 0MdG7486bnm8ofYxrItsVIxlGfbt75VOF5ybVjmNvYuFU+vma/ffw/fGeP8sTo+H
# LC5CWMag2cPIrVlT5X7vVTLcxLSRN+IFHdIQko9Dj0LdISXLLVAsUQMPTi7X6xzZ
# I9t3cxN7vPhl92NuJoUZRTixceb1lcRTh1guxX2N6itC+4a4tM47lvkYXKHtMuwD
# Sw8MXl3AHCcrZGklUJYZTLs77tTALnk0GRfITX+lv1INsTl6Ck9BwxGwaSTmwPb8
# HzLA8F7N6nBP11EfPOwe+kjSrwN1bvMBy7OJpVqYtksvVT3e5FddOt28lyezo+Ln
# uTEfcUB8tiDlzEgPPS3xWaFRQx8N4aGMGF2kNq94R9l7o+zME8lySpDmk8xUVGQT
# P/7LKSf5WZqyvu49Tk/cg+2dUPx+kHs9nCD+TYVE6Zi8WCwXoUz54gzI0eAgIh+B
# 58z+GDORW+l/UT8NxDzW8CZqzBa7NOZnAzS9nLcxLBIViUauboV/yeHYEdWPIOkq
# 6IqKLh8XtS5ISoC2mHQ+L76XMz8=
