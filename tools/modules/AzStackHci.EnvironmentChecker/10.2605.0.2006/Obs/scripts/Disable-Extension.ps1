...
$WorkLoadName = "Disable" 

Set-HandlerLogFile

try {
    Write-Log "[$functionName] Entering. Disable script started."
    ...
    Write-Log "[$functionName] Exiting. Successfully executed disable script."

    Set-Status `
        -Name $WorkLoadName `
        -Operation "Disable succeeded" `
        -Message "Successfully disabled extension." `
        -Status "success" `
        -Code 0 ## PS Success code
}
catch {
    $customErrorMessage = "[$functionName] Exiting. Failed to disable extension, "
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBTQ/Fa8P5uySQo
# kcz0CSZ3+nHi//ooEQwQOfjgBFjvjKCCDLowggX1MIID3aADAgECAhMzAAACHU0Z
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIMEb1zb8
# dt8DaKFfwy6yt9SXoQRD/OP/x/JYZLzlEZxeMEIGCisGAQQBgjcCAQwxNDAyoBSA
# EgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20w
# DQYJKoZIhvcNAQEBBQAEggEAM03xXAB2RDN+4FQ7fnWsqqwTxrscNjBaBtAPXr4L
# C5DdDyg6O9KI7Xt+yyIQppWAkeJnbieORYdebSqzd2Iv8LQ8EgkPNsLeZ8qwGxBK
# dKom3SpZGMMJQkdpFzCwst6TOOQKULQLIOZXqBq5xmIINbu/UJiRnaph5Ts+nYds
# FBJzW/V4qFvmxk0UHucS0/sUIMS+NNZK2ZdsLHV7QR6q/NVxapRX2z8mM1btvVk7
# kzEmDQLkR3nTBlba2q+uI7Eq+2Y8NbYFwkhhqt9fmAZKLv1GoqqDZz5octrc7Sdo
# QQWspOnRsxJX8OD3gNGSi9ke60bQUIkbL/VhSasHGPPZPKGCF5cwgheTBgorBgEE
# AYI3AwMBMYIXgzCCF38GCSqGSIb3DQEHAqCCF3AwghdsAgEDMQ8wDQYJYIZIAWUD
# BAIBBQAwggFSBgsqhkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoD
# ATAxMA0GCWCGSAFlAwQCAQUABCCZYLlt9nmDfgBUDhfbKgGTBLfFWcRg+MwD3gz6
# ck/s2AIGaedvdqK4GBMyMDI2MDUwMzE0MzEwOS44ODFaMASAAgH0oIHRpIHOMIHL
...
# CyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCBbZVocnixr2qIrXZ29GFkZnAff
# jXxXWQu5TDjwkFdfPzCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIOXnARo1
...
# r04Oo+JUzKEPgrDA4S5x0iC3AdGRSnJxTHwwDQYJKoZIhvcNAQELBQAEggIAmHoE
# R8YfrZzfBjJPBU+oyvz9sb5zj3JLezD+eIxmpfRo7Q3qtM7ew6wYBkA3w7IQrfo7
# i+Ao4lN1qIvnU516WQzmFLhPKYsEAsHOS+W7NO9QKl9QVp5NyDonp8ab+YrV6wn9
# bg83/sNxX31Xs3D/ZfyWDjrKmvLqCUsUWvuXo6ZXKbmZO9hkCNJlqxLVoXFNno5j
# FeQcxtXhnwHNC0AhUsABuwlYSGpePxCNg3Xv4q5jlu/uKv+reAe54msho0ebNTtO
# 08qOodEQKTnLtHA9Ln4jUN2bKrYB/+a9OFH8gD2F6IMcXX7Fef7NLwD2hEeCSG1J
# 5hc0iZ0V5u252BMZrT5p8CZCKRYQjiv+YPhMaeokes8OEbVUWvUnak+tuT/nSZeu
# GHzCzpT2M+6sYajO16EQbbFfIAg/1Ah+4WAyaK4rvSPW7JKTA1lztCgLh+B9IZV8
# m7NAtmxYrrVWUBpF+Nz5l3anr/row3mOctnDPFMTCiV64aQzGB7SROKT5f43eGoj
# gduB8MX/gidILyrjxK08iBtSainlTAlvBnPKF+XTqK+ciAlushtJ3zJrLU0ycVyn
# 5b2FqV2L4JX5XC4VvqVA9xvXOnaPA39UhXOWLZyh1Z+mYmxlFlxZp8s9Hte2Altt
# mOIOMOLJ305rzEUepTdC2yZx+qGz7PTNw/bTpI8=
