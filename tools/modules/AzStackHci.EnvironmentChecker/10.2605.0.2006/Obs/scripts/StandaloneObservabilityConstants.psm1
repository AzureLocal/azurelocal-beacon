##------------------------------------------------------------------
##  <copyright file="StandaloneObservabilityConstants.psm1" company="Microsoft">
##    Copyright (C) Microsoft. All rights reserved.
##  </copyright>
##------------------------------------------------------------------

$PipelineConstants = @{
    ArcForServerAgentWebLink = "https://gbl.his.arc.azure.com/azcmagent/1.54/AzureConnectedMachineAgent.msi"
    ArcForServerMsiFileName = "AzureConnectedMachineAgent.msi"
    ArcForServerExePath = "$env:ProgramW6432\AzureConnectedMachineAgent\azcmagent.exe"
    GMAFolderPath = "$env:SystemDrive\gma"
    DeviceArmUriFormat = "/subscriptions/{0}/resourceGroups/{1}/providers/Microsoft.HybridCompute/machines/{2}"
    # ArcResourceUriFormat = "/subscriptions/{0}/resourceGroups/{1}/providers/Microsoft.HybridCompute/machines/{2}"
    ParsingEngineExeName = "Microsoft.AzureStack.LogParsingEngine.Engine.exe"
    TranscriptsFolderName = "ObsScheduledTaskTranscripts"
    ParserScheduledTaskDescription = "Task runs every hour to parse diagnostics logs from factory share"
    ParserScheduledTaskName = "Start-ParsingEngineForDiagnostics"
    ParserScheduledTaskPath = "\Microsoft\AzureStack\StandaloneObservability\"
    ExtVerEnvironment= @{
        VariableName = "AZURE_GUEST_AGENT_EXTENSION_VERSION"
        VariableValue = "0.0.0.1"
    }
}

Export-ModuleMember -Variable PipelineConstants
# SIG # Begin signature block
# MIInSQYJKoZIhvcNAQcCoIInOjCCJzYCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBPpvKf5pmXfe3x
# cX1W8wuwD42n4Ac3r0Uzu6HbNqAkdqCCDLowggX1MIID3aADAgECAhMzAAACHU0Z
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEILNTXWVk
# feXp7VkITU7oAN6ggA6XZIo418gjGt3qfZQRMEIGCisGAQQBgjcCAQwxNDAyoBSA
# EgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20w
# DQYJKoZIhvcNAQEBBQAEggEATKVWF4Nv0HeVIZaJ/oPR5JurlF5ak2oeOYMTLsRO
# w3HMBVOpv1n4NO4e/Pwv0ieZt4v+fmT7Glfs+iRjf6meg5asxP4yF3Qr4ZhxSE4Z
# eC/cJO6Rjh7zI10owHcgd+JtUA7+pszBr4aa06NSgnrd5zSby4a2QNQl2HDCCHrp
# DnuNXMBaItUNS+GUuHzi8BY2Id7dDrmCn6oVje1Kgc5l0bDxWFjBhB073zYkx2ci
# dfJN2ZseX0AGXRC4/Skvol9j+FoVeqYmd5YKo9X2UKoRRz2HyqQbVJoTS6QCB5SW
# T1NpogbE8gXUwV3Nc28qK1ktn5uCReabZL0fR55HsszLcaGCF5cwgheTBgorBgEE
# AYI3AwMBMYIXgzCCF38GCSqGSIb3DQEHAqCCF3AwghdsAgEDMQ8wDQYJYIZIAWUD
# BAIBBQAwggFSBgsqhkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoD
# ATAxMA0GCWCGSAFlAwQCAQUABCAilSbBky7LBGLjoQdjdebBjCBjP2CW52LdGBxX
# cv0QtQIGaed8mPP7GBMyMDI2MDUwMzE0MzExMC45OTZaMASAAgH0oIHRpIHOMIHL
...
# CyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCBvipSY9wVp2oP9VlY7kew++11w
# TLZlgbaWdN+aCP7wMDCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIFYN7oh6
...
# rJMLOtfvraiqGafeCm8jnD39Hjc3g6/seDMwDQYJKoZIhvcNAQELBQAEggIAlIdV
# xFB0FoStxVue8o1jPQ6Sb9UoqfMjz/ZDVr2p8fxXvokkpI8+Vf9DHPwkZhPz/i/a
# xst94nk8qGUr99WvJq5571yNJ6iW2VVadA2nAhxCeDNZG5GsqP7wijUzc+MsJFwO
# shM3h4sOyUADU7QnCbO5GzPG5THacmoHAdE02pg1MuFAc8SuJ8oXqDRFDswyxj17
# /kC3+K7wRgrRNOKQ2bop+TYRzwCDwqCuaAhyWmk57N0+u2RYbfZv3dVe4j9tO0at
# ZpD+xZP2HuHW2+dT1DOk0GU35iTxUgTG9YVNMTx6aqO+QLg2KOtBQ0/XgBH/zwuD
# 0LtznEza6tIvxFNNeCmVcAH8jt13C4efVtarkIWOBnz71tu1NCD/o11hRed1vQAK
# CX23u2jiaugNA4nHCN2rtUr0ss9sHlGH+lIL6B9rdt7Mj4mCFNH9GMrV/ZSksRsS
# 70+pkGZd64GBuhWOiWmlm74B8tt/tI8UTvfafDAHV2Wv5Pjsd9zdIJkgSjBbTdbb
# ob/TTZb/Y39OPmapa92OtB7ycOzufnENhGGanQnHgif7yJS9JHcF8Phf4CfOs/81
# wQT+S9YJpGvYO9bnDExFRVuJyE91XDe2qkpN+gnbgvUSA5xcT+S9lHXbA2eq/po2
# TK00rVteJ1dd2x7K4S/iSJGUMgXB55qmZKVWTEw=
