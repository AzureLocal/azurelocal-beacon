...
$WorkLoadName = "Install"

Set-HandlerLogFile

try {
    Write-Log "[$functionName] Entering. Install script started."

    $obsStoreRootPath = Set-ObsStoreRootFolderPath -SetAcls
    Set-ObsNugetStorePath -ObsStoreRootPath $obsStoreRootPath -CreatePathIfNotExists
    ...
    Write-Log "[$functionName] Exiting. Successfully executed install script."
    ...
    $customErrorMessage = "[$functionName] Exiting. Failed to install extension, "
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCXv3DZB0/JBoQ0
# YdkoMSu1dKiP3dSy0tgL4zNMQCzJcKCCDLowggX1MIID3aADAgECAhMzAAACHU0Z
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOSqlEwZ
# 3iE7WZKlG6CTM6bdiJm2Pv5LuBhI/c1Nrv6CMEIGCisGAQQBgjcCAQwxNDAyoBSA
# EgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20w
# DQYJKoZIhvcNAQEBBQAEggEAdRkSyMaJTdK4QZPyL/L6WjpeW0EBVaLcDHar94Wy
# ViJIfDw4ZxBDxgrxrK8qR05icrApp20OWCqJiKTi1IHtRL2sloggdHVKoM5H/BVV
# L0n76WsT11lKF8uMRGpB6dbkYqDbPYYL0Z1+CGLQcD3D6E/W2H5FxP3OXZ7bMVzU
# QF6Dmwy6kWF6PcqiwdNmd9Mu/mtyCtBTb+3aObhbNnaYyl5zHuuZaT9r9swdJliy
# Cp9sgTsWmdLoylO+u6Ri4Om5vXFkHFwv7yLu4+ubIbvbEHY354sQ3UAQR1gISLGR
# R9yCEvLIseisf1FVGnDsh74/UOpMo3r5aPU8GGLrg7TDuqGCF5cwgheTBgorBgEE
# AYI3AwMBMYIXgzCCF38GCSqGSIb3DQEHAqCCF3AwghdsAgEDMQ8wDQYJYIZIAWUD
# BAIBBQAwggFSBgsqhkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoD
# ATAxMA0GCWCGSAFlAwQCAQUABCC3FHHYZYdJ6Wwdp/NMl40irrFQRcpxvZm0/5Id
# vh7XEgIGaefsSc0DGBMyMDI2MDUwMzE0MzQzMC4zNjZaMASAAgH0oIHRpIHOMIHL
...
# CyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCBRDviD7JOmixr+5jBpUMYYihFJ
# y2bKPzhBg6EZmo3bBTCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EION7vyOl
...
# CfUpoXjUtBZKerlMmArdnX03kdlRHISH7mUwDQYJKoZIhvcNAQELBQAEggIAzRmo
# AejQeeezT89Q7Rqu/XQZv4+EvBu5MGJkF9VXE6Wal91/qDQKXPyyh3gmp65XWIJP
# rbXsNHwAKyuRIx7Tx3aY4A9EdlhEzKZ8Pc4Bhm3SkxhvM6bvElfJFAa3KQtKLkhz
# ybVaowsZ/aM5h7UZF7ZTHurcqhT8i47n8CoF+aY8jkQU8Xgt+sThCdcyDIz2kHWW
# VPpvBjgINLB5YCTuC5hg8dIxncSVHUipLKaY/FsxoZTromEZP9STt0NzzZZXaeNU
# XlVDev2+B781oryLQwr51c6iu0QxZHaetHsXsDRZWTlXDmVElZ+rF3tV/DwoJKdR
# UFcvwSOmktfmv1/C8owjC3p2tBCb8uTJshd47fmyBESkB0MGefBN/j1eNehGeG/Z
# jDKv1+rVLjw7Q03++tMN3M1CDXiUzqAePXhf+zucZNs7E2y4iXIKGQb4YpMJ7cwd
# s/L2LoPzO9mWmj+8nGUmlBuZJJx0MqllZTC+sHgSYX6BC2ViWsPiAAg4rEcCCuRn
# 8tG8HBxi+fcbuqP3S9th+Uxp9BHkEgCB9nt7K+XzMLy/BPl8M0KPegzGstuR0ln3
# NK23CRTwjD99MZPQyJSe0tJr6xJg9onNqejtrpqxe2BD7Rw1BersVBmGgSIOSCOJ
# xWlgAhIhRvsfp9SN6TMFRhqRF19him1PqPtLI9c=
