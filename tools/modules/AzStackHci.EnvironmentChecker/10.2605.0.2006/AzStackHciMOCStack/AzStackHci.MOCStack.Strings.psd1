...
PsSessionFail = Unable to reconnect Ps Session on ({0}). Error: {1}
TestProgessInfo = Validating MOCStack Test : {0} on {1}
MOCStackVolumeStartInfo = Starting MOCStack's volume validation.
MOCStackVolumeDriveInfo = Using physical drive letter {0}. To change this value, supply the -PhysicalDriveLetter parameter.
MOCStackCPUStartInfo = Starting validation for MOCStack's CPU configuration.
LowCPuMsg = This host does not have enough CPU cores.
MOCStackMemoryStartInfo = Starting MOCStack's physical memory(RAM) validation. 
LowMemoryMsg = This host does not have enough physical memory(RAM).
MOCStackPortInfo = Starting MOCStack's Network Port enabled validation. 
DisablePortMsg = MOCStack mandatory network port is currently disabled.
MOCStackFirewallURLInfo = Starting MOCStack's  firewall URLs allowlist validation. 
BlockedURLMsg = MOCStack mandatory firewall URLs is blocked.
MOCStackNodeAgentInfo = Starting MOC NodeAgent service validation.
NodeAgentFail = The state of the MOC NodeAgent service is currently undesirable.
MOCStackCloudAgentInfo = Starting MOC Cloud Agent service validation.
CloudAgentFail = The state of the MOC Cloud Agent service is currently undesirable.
ClusterNodeInfo = Starting cluster node validation.
ClusterNodeFail = The state of cluster node is currently undesirable.
'@

# SIG # Begin signature block
# MIInSQYJKoZIhvcNAQcCoIInOjCCJzYCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDT9YflqcrM04x9
# PgRVUZ6VISPthqadH9zRtgD3BGifFqCCDLowggX1MIID3aADAgECAhMzAAACHU0Z
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIM9V6P8D
# ql387pLpq0qseYKbKMPee0OaJXBUdr19ShGyMEIGCisGAQQBgjcCAQwxNDAyoBSA
# EgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20w
# DQYJKoZIhvcNAQEBBQAEggEAunOxPlLkYuDAJB/5e8Ma1gIzPqIZSGT2TePItOQ7
# 4yr9D2fdCtkyoANr+YGYpAr6inqa2kRKHXA37OmMme2vH9pRxPoNxz+oYj3gwaSX
# zRVus+SE9BORpXa1c2D7hXhlGeoEbKwCShY0eqtUNA1XAkItl0NXaeiXk+uxTYZ/
# T8ipSVrzSWr04n+wo0IC3Oos48kQ0nPMMGwgusgmOMB1shBRSLup9X8LZK1yFRoX
# v9r3ObRBGSC3e58hXuJwJbiDRW5W6AYAScPPfa52sJn28BlPWrZgm8VRgJ1f+xoa
# NyiUvaZVxwT3zNyzW/2ry6WW8XEYHUsGkbzfWje1gUhufKGCF5cwgheTBgorBgEE
# AYI3AwMBMYIXgzCCF38GCSqGSIb3DQEHAqCCF3AwghdsAgEDMQ8wDQYJYIZIAWUD
# BAIBBQAwggFSBgsqhkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoD
# ATAxMA0GCWCGSAFlAwQCAQUABCAbULLKgVuwm6gEE9h0r/fdsafjqMJKvUq+J9du
# 7Q1snAIGaeexRuPZGBMyMDI2MDUwMzE0MzExMC4zMDZaMASAAgH0oIHRpIHOMIHL
...
# CyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCAzInOl4/79qPMw9Vfmn8BWuWid
# +h+ScJAk3ecoBd+waTCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIAVgXQEK
...
# OOQNtThs8JIT4pVZxK+0CdTvxImeg/PVxbcwDQYJKoZIhvcNAQELBQAEggIAbjoY
# WeKTtEknT0t+Pt3Eszf4g5LDcA2NIN9qlRLtK8TG22iUQCmIap5SLatGO2nXfyfo
# 3vkq1vA4EwRJsl7aQF8zrzcD7sGW7idGQyiJLV0h7LX0SjFQqwjx8ya/vmTc5yDL
# guuiUcesOXMjg7vli30w6TILR3n6V7cLx6+heesmwIhRBp0w7z5BxydUmamgpgWK
# LaRguuJMsVdiMWhH5bKXTjPh5Sktz7YezwxJnCMPxOoJSNVKZqQ1FEq3JNE5q+Jp
# IHx92LBplna92l6FMiAM2L5+8tNiHe4+3jScM+iH64qnU5q+te6hmRwYYAmAobeu
# 9I1BsYnZGidwiI/5zY9Enl/Y8TnibP/7669EQmJiXUGahdBujXMfZFuZ2LHmtsQJ
# 7L9+ZTVF7c7e2yvkhCcGuKYqKLcIiCe1MNOCQEgo9DadBAXxd6uDCnDs0dnYfeVa
# 50tZJKo3kYvBcFyG/RySePz8754B7yYgPn2Sfw9LCqHeZBx+gU0iWPJbHmd/Hfk2
# xEuOuXMfK4/Jo0oelX3Ym2vSOBzZU4jMPDIgBPnKxhFQlQtTlt/LoggVTueBBUE7
# +oeIspsIGV5tzXRpx8wFofqP6rskRbGo6TQ0I0GgHUdGGN3Az7E0WeoSivp6zYUc
# Llx/DhYb/pkWEV8Wu7vT6SPUaJTYBwaL8akvWlk=
