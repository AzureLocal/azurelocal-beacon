<#############################################################
 ...
 #############################################################>
$MetaData = @{
    "OperationType" = @('PreUpdate','PreUpdateJIT')
    "UIName" = 'Azure Stack HCI Security'
    "UIDescription" = 'Validating security configurations on Azure Stack HCI nodes'
}
function Test-AzStackHciSecurity
{
    param (
    ...
    try {
        ...
        # Security validator uses ConfigDefender module for Get-MpPreference cmdlet (optional import)
        ...
        Trace-Execution "Starting Security validation, detail output can be found in $($outputPath)\AzStackHciEnvironmentChecker*"
        $SecurityResult = AzStackHci.EnvironmentChecker\Invoke-AzStackHciSecurityValidation @Params
        ...
        if ([EnvironmentValidator]::ParseResult.OverloadDefinitions -match 'EceInterfaceParameters')
        {
            ...
            return [EnvironmentValidator]::ParseResult($SecurityResult, 'Security', $FailFast, $Parameters)
        }
        else
        {
            Trace-Execution "ParseResult method does not support EceInterfaceParameters argument"
            return [EnvironmentValidator]::ParseResult($SecurityResult, 'Security', $FailFast)
        }
    ...
    catch
    {
        ...
        # Uncomment the following when error EceErrorAction="SilentlyContinue" is eliminated.
        # throw $_
    }
    finally
    {
...
Export-ModuleMember -Function Test-AzStackHciSecurity -Variable MetaData

# SIG # Begin signature block
# MIInbgYJKoZIhvcNAQcCoIInXzCCJ1sCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCyG+0YfBYOaD1Y
# ZzHigSUL53rXM2wrPDYycAB3m4F4r6CCDMkwggYEMIID7KADAgECAhMzAAACHPrN
...
# hvcNAQkEMSIEICYfZAB0XrGcwLcEndSNScdFtBFqAj562dzYtnW0CaukMEIGCisG
# AQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3
# Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEBBQAEggEAYzt5PHjmA4d5O33rEx1s
# r+r2zcHspkZuwWyI4qfognGft7uQiQx1pM1MIvOcRSrqAco/qSpe2OSfhWCNpqJ/
# GQ+GZobJ+MbYxXdlVzj0jHCtTbVld0YCSZzgm9oBMOLOjwO/nbuGgIpCI7KTwxiy
# 3yFnqAA7CnlWL0BZc9jcmIQ/UgLfjSdDfIYPMHdV+rHdzOEM8tYh3f7nP4e/BnAb
# mMtHY+0kIMwzxQ53LuS22KBuKdf7zC9iEMPvMgQevXXuQXL6Yhv+nBItds+3f5TR
# Rf32GSAbg1SHjJ42KdvvTGQzFrGSz4fNDCCcWkH076Kl0H3yjVC5QMxczgAdCXXq
# V6GCF60wghepBgorBgEEAYI3AwMBMYIXmTCCF5UGCSqGSIb3DQEHAqCCF4YwgheC
# AgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFaBgsqhkiG9w0BCRABBKCCAUkEggFFMIIB
# QQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCAzOU2V+c+AivV16TLO
# p6U0kkjIqrulYW6KDXyswgdymwIGaet1mUk3GBMyMDI2MDUwMzE0MzEwOS41NDla
...
# BDAvBgkqhkiG9w0BCQQxIgQgQXCTL6sUOUbN/DWBk7rkeQErdC6L8v66hrfmNJiF
# fe8wgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCCdeiHHrbtpKcwB20doVU89
...
# yavIHZTcYA5xN6GxveJWMA0GCSqGSIb3DQEBCwUABIICAGbMM0pYduxtpAR83oRB
# NsURDF9MG4g2Wl3EiZYKamzx5VMMorpsM3u2Asfww+zmV2t5jfo+GicqqExK7pVZ
# kBoZuDstPSFo4uht1l8Nvu2OQPs9Dfq7ZLt4W+Q0SX17L8T+r78UW48FrgJzaIOT
# X1m1iiklse1T9uL44v9x7ez6yfvcedFLNTx99A0k0brKSsN5Unq+jIJ6Unz/g+DA
# ZfHBGxPHTFb6YAtH7tG9k13Kx5AaXhayZxuAn7fhr40cuJTdRqxXY2iu7UOkI1eQ
# 81avXdWKljOfozEowWo8BGX5VC3jXkYgN/BUQ/rBGgQdTayRZqkHXFp8g5iQwpyf
# nwwX5Att1towa10fKusjbRbL7siy6JDE/z2lgia1od0iGe4UquBIV/zJveNCVzff
# usa+kqIPJQHZ3fz9B/StiwAiIC+wwyCrUlNgYb/JRDpYQLX9ACFUMjKOKLNrHCK5
# ewd6YZU3CeWgDSuQpePI72ueKwcigPl3laSegG1pX1U1Hk+Ce1HscV23fK2YzKny
# 6ayzU9Aa8sLBsi0g0exr04KNBrjrNA5d5K+XeGcZF8+LgMKig9dEgjJfE7HbDppy
# nbiA4gln5mYT7/g1s03yAehYTRZ+jZkrjH1ZU7Ab3YcGt7yXZecjQzw25FF99xPc
# 1mHsZYP4XRS6x4VXgnP/dzZT
