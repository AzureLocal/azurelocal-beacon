...
@{
    ...
    GUID = '2c38f191-d268-49e0-b734-80c8b3ad2c2a'
    ...
    Description = 'Microsoft Azure Local Environment Validator Common Library'
    ...
    NestedModules = @(
        'AzureLocal.EnvValidator.CommonLibrary.Network.psm1'
    )

    # Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
    FunctionsToExport = @(
        'EnvValidatorNwkLibCheckTcpConnectionWithRetries',
        'EnvValidatorNwkLibConfigureVMSwitchForTesting',
        'EnvValidatorNwkLibConvertIntToIPAddressString',
        'EnvValidatorNwkLibConvertIPAddressToInt',
        'EnvValidatorNwkLibConvertToPrefixLength',
        'EnvValidatorNwkLibConvertPrefixLengthToSubnetMask',
        'EnvValidatorNwkLibCreateAtcHostIntentsInfoFromSystem',
        'EnvValidatorNwkLibEnsureTestSessionOpen',
        'EnvValidatorNwkLibGenerateRandomIPInSubnet',
        'EnvValidatorNwkLibGetIpRange',
        'EnvValidatorNwkLibGetMaxParallelJobs',
        'EnvValidatorNwkLibGetMgmtIpRangeFromPools',
        'EnvValidatorNwkLibGetNetworkAddress',
        'EnvValidatorNwkLibGetSortedMgmtIntentAdapter',
        'EnvValidatorNwkLibGetWinProxyConfiguration',
        'EnvValidatorNwkLibInvokePing',
        'EnvValidatorNwkLibInvokePingWithRetries',
        'EnvValidatorNwkLibNewPsSessionWithRetries',
        'EnvValidatorNwkLibNormalizeIPv4Subnet',
        'EnvValidatorNwkLibTryCreateNewPsSessionOnNode'
    )
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDfY1NhJ7WjI0JK
# O3W5OU4Lwjhd9dGn9cPOWPFkxpmlFKCCDLowggX1MIID3aADAgECAhMzAAACHU0Z
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIDCqPTqI
# JY2lKqCMGHwAeieuetvxlHLnPsIszcgedfxIMEIGCisGAQQBgjcCAQwxNDAyoBSA
# EgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20w
# DQYJKoZIhvcNAQEBBQAEggEArR7eOhCArDQ7Hiqxo7nfmlpDZ557T2dy6BqKf0ZL
# nu9/xo9TM8WDY/QiO/wa9bP162UfCp0rCjbv9Y6sar2lQJhyyK0fAWu68kUwfzno
# oRwHF1xyPPPF6qigpXB4IIX1+yyyeAioCREwK74kg1cRIHFGLvkEDaQZ4p7yOEkG
# 0coBfAui6Re54RaWz4Dcp2rU0pZFo8xqrhI+7+BSNuuVxiJ/nuXXXfZnkFt9ysW+
# GonbYbrFCZOr9HEv5mUypSEWEI4sDwH1wfE6BoMmgRBAaL44LYIETauHdvj+5Ydt
# 5yiDpWxVjuJf0ga5BhmOIEjWWwhUDYWJsAjn0Ja0Gn2kuqGCF5cwgheTBgorBgEE
# AYI3AwMBMYIXgzCCF38GCSqGSIb3DQEHAqCCF3AwghdsAgEDMQ8wDQYJYIZIAWUD
# BAIBBQAwggFSBgsqhkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoD
# ATAxMA0GCWCGSAFlAwQCAQUABCCOp5PJbu2jkNSe+7bWuQ3wr51FojJfe95qjgCI
# F4LkQgIGaeegqJ7YGBMyMDI2MDUwMzE0MzEzMC41MDhaMASAAgH0oIHRpIHOMIHL
...
# CyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCApF6Ia+w1llhPBAZ1iUoBpaT4w
# Hl/4TN2tQpZGy6XDUjCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIC+BXWrz
...
# szm+d0/kpKtiIuKHE8oW2d9Vtqy9flj8PCswDQYJKoZIhvcNAQELBQAEggIAeyGU
# 5c4xcxe3Mr/d97RUbwbN6VzBgdKVqoLFNe3E3vOCcPyOdxY+XL+FJAtusEcjC8u6
# SQ4cye5by6liPDou3xiq8TrqrgsojJEl332f/PlyUPNwFpBr59nk2lKWDn414dY8
# ckanbhHDv/xMZAC+q4AE1cGP6KSZJkl01VQaJwSi0PCI2N6blZCZFSLOWf4eWk47
# MPtEySpjvmxP5xD5shsyfnP9w0h/cZdqvHFt2Ob6tuRtTejYeLALrLSrPfgZIo5o
# haXPtfOdGBE+Q0IyM6DM+yZbuYSxQO5pbZZLjJkVD3CYQ5qpDOcPt+ZM+DyPPci+
# 2mm6D/3Y7LkI5Uwr8D7APPMtd9HVw9Zip78dRs1Z+MISYvW/cPXCHeHd8DvYKmF4
# QHryMk8qZ+9VoU4wauf+GfvZyW8mv0osVe96ejnJbstjYuUAtu4q/u/22vu0w0nj
# JDAJ/z1TcdefCjv30VlUx5DJ3rnywg6sV3C8dIB3Ott821+IGm0NjUZ6NCcyUMlB
# s3TCAPLhW+qSX7YS6kFk1fsKMVgfEaCiTld3XnVlZ0lwak7NrcAU2qj8oZBnqVBV
# iS0hBAyjwtP23zSekrD8jLCInktOuyl9S7FEvCI+ZPcETS0ty04ncUICFWQOhXmP
# UZtGsEi5TByH66BBhcfH7XR8lgIU42J5fXtwEZY=
